...
(async () => {
  ...
  assert.equal(refreshed.version, 39);
  ...
  assert.equal(upgraded.version, 39);
  ...
  assert.equal(backed.version, 39);
  ...
  assert.equal(stills.version, 39);
  ...
  assert.equal(filled.version, 39);
  ...
  assert.equal(bpFilled.version, 39);
