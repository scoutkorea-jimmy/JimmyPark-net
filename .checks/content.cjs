...
(async () => {
  ...
  assert.equal(refreshed.version, 41);
  ...
  assert.equal(upgraded.version, 41);
  ...
  assert.equal(backed.version, 41);
  ...
  assert.equal(stills.version, 41);
  ...
  assert.equal(filled.version, 41);
  ...
  assert.equal(bpFilled.version, 41);
