...
(async () => {
  ...
  assert.equal(refreshed.version, 40);
  ...
  assert.equal(upgraded.version, 40);
  ...
  assert.equal(backed.version, 40);
  ...
  assert.equal(stills.version, 40);
  ...
  assert.equal(filled.version, 40);
  ...
  assert.equal(bpFilled.version, 40);
