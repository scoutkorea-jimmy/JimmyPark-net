  ...
  "pages": {
    ...
    "lecture": {
      "meta": {
        ...
        "desc": "Korean-language lectures and workshops by Jimmy Park on branded film, youth media, applied AI and Scouting — plus 1:1 and small-group sessions. English available on request."
      },
      "order": [
        "intro",
        "talks",
      ...
      "sections": {
        "intro": {
          ...
          "lead": "I teach branded film, youth media, applied AI and Scouting communication — in classrooms, centers and conferences, and also in 1:1 and small-group formats. Sessions are shaped for the people in the room.\n\nAll lectures to date have been delivered in Korean. Korean is the default; English-language sessions can be arranged when requested in advance."
        },
        "talks": {
          "kicker": "01 / History",
          "title": "Lecture history",
          "sub": "Selected public and institutional engagements",
          "desc": "A selection of institutional lectures and workshops. Beyond these, I have also run many 1:1 tutorials and small-group sessions for individuals and teams.",
          "items": [
            {
              "year": "2026.09",
            ...
            {
              "year": "2025.08",
              "category": "Scouting × AI",
              "title": "From Analog to AI Native: The Scout Path Built Across Generations",
              "org": "Korea Scout Association (한국스카우트연맹) — National Training Leaders Conference",
              "role": "Session lead",
              "summary": "30 Aug 2025 · Session lead at the National Training Leaders Conference (전국훈육지도자대회).",
              "href": ""
            },
            {
              "year": "2025.07",
            ...
            {
              "year": "2022.08",
              "category": "Scout media",
              "title": "Video Content Planning",
              "org": "Korea Scout Association (한국스카우트연맹) — 15th Scout Journalism School",
              "role": "Instructor",
            ...
            },
            {
              "year": "2021.03",
              "category": "University",
              "title": "Virtual Company — University Course (Co-taught)",
              "org": "Halla University (한라대학교) — Department of Media Advertising Content",
              "role": "University co-instructor (Hello Peace Lab)",
              "summary": "Spring semester 2021 · Semester-long university course for Halla University students (course name: Virtual Company; formerly Dept. of Advertising & Visual Media).",
              "href": ""
            },
            {
              "year": "2021",
            ...
            },
            {
              ...
              "org": "Halla University (한라대학교) — Department of Media Advertising Content",
              "role": "University co-instructor (Hello Peace Lab)",
              "summary": "Fall semester 2020 · Semester-long university course for Halla University students (course name: Virtual Company; formerly Dept. of Advertising & Visual Media).",
              "href": ""
            },
            {
              "year": "2020.11",
              ...
              "org": "Jungnang Dongbu Market (중랑동부시장), Seoul",
              "role": "Instructor",
            ...
            },
            {
              ...
              "org": "Bucheon Children's & Social Welfare Foodservice Management Support Center (부천시어린이·사회복지급식관리지원센터)",
              "role": "Instructor",
              "summary": "20 Dec 2018 · Internal staff training on Photoshop for producing and developing educational materials (adult learners). Historical reference: Bucheon 2nd Children's Meal Support Center.",
              "href": ""
            }
          ]
        },
        "topics": {
          "kicker": "02 / Topics",
          "title": "Topics I can cover",
          "sub": "Formats from keynotes to hands-on labs",
          "desc": "Pick a theme below — or tell me what your audience needs. Public talks, workshops, university courses, and private coaching are all possible.",
          "items": [
            {
              "name": "Branded film & directing",
              "desc": "Story, craft and production for films and director-led sessions."
            },
            {
              "name": "Youth media careers",
              "desc": "One-day and project-based programs for students exploring film and media work."
            },
            {
              "name": "Applied AI / AI Native",
              "desc": "Practical AI for teams and organizations — including Scouting leadership contexts."
            },
            {
              "name": "Scout media & communication",
              "desc": "Journalism school sessions and content planning for Scout communicators."
            },
            {
              "name": "University media courses",
              "desc": "Semester teaching in advertising, media and content programs."
            },
            {
              "name": "1:1 & small-group coaching",
              "desc": "Private and small-group sessions tailored to a brief, skill gap or project."
            },
            {
              "name": "Creative tools for work",
              "desc": "Photoshop, mobile editing and production tools for educators and small business."
            }
          ]
        },
        "cta": {
          "title": "Want to invite a lecture or workshop?",
          "body": "Feel free to reach out with a rough idea — audience, date, language and format. I'll suggest a clear session shape and we can refine it together. Korean is standard; English is available with advance notice.",
          "button": {
            "label": "Ask about a lecture",
            "href": "/contact"
          }
        }
      }
    ...
    "scouting": {
      ...
      "sections": {
        ...
        "roles": {
          ...
          "items": [
            {
              "title": "Unit Leader · Baek-ryong Unit",
              "org": "Gyeonggi Southern Federation, KSA",
              "period": "2024.01–",
              "accent": "green"
            },
            {
            ...
            {
              "title": "Future Value Committee — subcommittee chair",
              "org": "Korea Scout Association · Vision 2032",
              "period": "2024–2025",
              "accent": "neutral"
            },
            {
        ...
        "timeline": {
          ...
          "note": "From joining in 2003 through jamboree media, international contingents, and Asia-Pacific leadership. Expand a year to see the full list.",
          "items": [
            {
              "year": "2003",
            ...
            },
            {
              ...
              "context": "Authorized as Bear Scout (범스카우트) No. 1420 on 20 January 2012 — Korea’s top Scout rank.",
              "track": "Scout",
              "accent": "neutral",
              "href": "",
              "kind": "participation"
            ...
            {
              "year": "2014",
              "title": "6th Scout Journalism School — instructor",
              "context": "Instructor for the “I Am Also a Journalist” (나도저널리스트) program at the 6th Scout Journalism School.",
              "track": "Leader",
              "accent": "green",
              "href": "",
              "kind": "instructor"
            ...
            {
              "year": "2014",
              "title": "Intermediate Scout training completed",
              "context": "Completed Korea Scout Association intermediate training (중급훈련).",
              "track": "Leader",
              "accent": "neutral",
              "href": "",
              "kind": "training"
            ...
            {
              "year": "2015",
              "title": "ATAS membership No. 3226",
              "context": "Joined the Association of Top Achiever Scouts (ATAS) in 2015 (membership No. 3226).",
              "track": "Leader",
              "accent": "neutral",
              "href": "",
              "kind": "participation"
            ...
            {
              "year": "2015",
              "title": "Advanced Scout course completed",
              "context": "Completed Korea Scout Association advanced course (상급과정).",
              "track": "Leader",
              "accent": "neutral",
              "href": "",
              "kind": "training"
            ...
            {
              "year": "2016",
              "title": "20th National Orienteering Competition — photography lead",
              "context": "Lead photographer for the 20th National Orienteering Competition (전국오리엔티어링대회).",
              "track": "Leader",
              "accent": "neutral",
              "href": "",
              "kind": "photography"
            ...
            {
              "year": "2016",
              "title": "3rd Arab Scout Youth Forum & 28th Arab Regional Conference — observer",
              "context": "Joined the Korean observer delegation to the 3rd Arab Scout Youth Forum and the 28th Arab Scout Regional Conference to promote Korea’s bid for the World Scout Jamboree.",
              "track": "Leader",
              "accent": "green",
              "href": "",
              "kind": "bid"
            ...
            {
              "year": "2016",
              "title": "Daejeon Federation Cub Scout joint investiture — photography lead",
              "context": "Lead photographer for the Korea Scout Association Daejeon Federation Cub Scout joint investiture ceremony (컵스카우트 연합선서식).",
              "track": "Leader",
              "accent": "neutral",
              "href": "",
              "kind": "photography"
            ...
            {
              "year": "2016.08",
              "title": "8th Scout Journalism School — instructor",
              "context": "Instructor at the 8th Scout Journalism School (August 2016).",
              "track": "Leader",
              "accent": "green",
              "href": "",
              "kind": "instructor"
            ...
            {
              "year": "2017",
              "title": "International Service Award",
              "context": "Received the Korea Scout Association International Service Award.",
              "track": "Leader",
              "accent": "green",
              "href": "",
              "kind": "award"
            ...
            {
              "year": "2017",
              "title": "Korea Scout Association Citation Badge",
              "context": "Received the Korea Scout Association commendation badge (표창 기장).",
              "track": "Leader",
              "accent": "neutral",
              "href": "",
              "kind": "award"
            ...
            {
              "year": "2017",
              "title": "National Rover Scout Conference — Korean observer",
              "context": "Joined the Korean observer delegation to the National Rover Scout Conference hosted by The General Association of the Scouts of China (Taiwan).",
              "track": "Leader",
              "accent": "neutral",
              "href": "https://en.scout.org.tw/",
              "kind": "participation"
            },
            {
              "year": "2017.03",
              "title": "1st Scout Youth Mock National Assembly — mentor",
              "context": "Mentored at the 1st Scout Youth Mock National Assembly (스카우트 청소년모의국회).",
              "track": "Leader",
              "accent": "neutral",
              "href": "",
              "kind": "mentoring"
            ...
            {
              "year": "2017.08–2019.01",
              "title": "Uniform & Equipment Committee member",
              "context": "Member of the Korea Scout Association Uniform and Equipment Committee (제복장구위원회).",
              "track": "Leader",
              "accent": "neutral",
              "href": "",
              "kind": "leadership"
            ...
            {
              "year": "2018",
              "title": "President’s Citation, Korea Scout Association",
              "context": "Received the Korea Scout Association President’s Citation (총재 표창).",
              "track": "Leader",
              "accent": "green",
              "href": "",
              "kind": "award"
            ...
            {
              "year": "2018.03",
              "title": "2nd Scout Youth Mock National Assembly — mentor",
              "context": "Mentored at the 2nd Scout Youth Mock National Assembly.",
              "track": "Leader",
              "accent": "neutral",
              "href": "",
              "kind": "mentoring"
            ...
            {
              "year": "2019.08",
              "title": "12th Scout Journalism School — photography instructor",
              "context": "Photography practical instructor at the 12th Scout Journalism School.",
              "track": "Leader",
              "accent": "green",
              "href": "",
              "kind": "photography"
            ...
            {
              "year": "2020",
              "title": "Mugunghwa Bronze Medal",
              "context": "Awarded the Korea Scout Association Mugunghwa Bronze Medal (무궁화 동장).",
              "track": "Leader",
              "accent": "green",
              "href": "",
              "kind": "award"
            ...
            {
              "year": "2022",
              "title": "2nd World Digital Camporee — Marketing Director",
              "context": "Served as Marketing Headquarters Director for the 2nd World Digital Camporee (세계디지털야영대회).",
              "track": "Leader",
              "accent": "green",
              "href": "",
              "kind": "leadership"
            ...
            {
              "year": "2022",
              "title": "Commissioner Course completed",
              "context": "Completed the Korea Scout Association Commissioner Course (커미셔너과정).",
              "track": "Leader",
              "accent": "neutral",
              "href": "",
              "kind": "training"
            ...
            {
              "year": "2022",
              "title": "Wood Badge completed",
              "context": "Completed Wood Badge qualification.",
              "track": "Leader",
              "accent": "green",
              "href": "",
              "kind": "training"
            ...
            },
            {
              "year": "2024–2025",
              "title": "Future Value Committee — subcommittee chair",
              "context": "Served as a subcommittee chair of the Korea Scout Association Future Value Committee (미래가치위원회) and helped shape Vision 2032.",
              "track": "Leader",
              "accent": "green",
              "href": "",
              "kind": "leadership"
            ...
            },
            {
              "year": "2024.01–",
              "title": "Unit Leader, Baek-ryong Unit",
              "context": "Unit Leader (단대장) of Baek-ryong Unit, Gyeonggi Southern Federation, Korea Scout Association — ongoing since January 2024.",
              "track": "Leader",
              "accent": "green",
              "href": "",
              "kind": "leadership"
            ...
            {
              "year": "2025",
              "title": "Mugunghwa Silver Medal",
              "context": "Awarded the Korea Scout Association Mugunghwa Silver Medal (무궁화 은장).",
              "track": "Leader",
              "accent": "green",
              "href": "",
              "kind": "award"
            ...
            {
              "year": "2026",
              "title": "15th Korea Jamboree — Head of PR Department",
              "context": "Head of PR Department (홍보부 부장), Planning & Coordination HQ.",
              "track": "Leader",
              "accent": "green",
              "href": "",
              "kind": "leadership"
...
// v25: lecture refresh — language note, topics, 1:1 note, year-month, categories, university clarity.
const V25_LECTURE_PAGE = {"meta": {"title": "Lectures & Workshops | Jimmy Park", "desc": "Korean-language lectures and workshops by Jimmy Park on branded film, youth media, applied AI and Scouting — plus 1:1 and small-group sessions. English available on request."}, "intro": {"eyebrow": "Lecture", "title": "Lectures and workshops\nthat travel.", "lead": "I teach branded film, youth media, applied AI and Scouting communication — in classrooms, centers and conferences, and also in 1:1 and small-group formats. Sessions are shaped for the people in the room.\n\nAll lectures to date have been delivered in Korean. Korean is the default; English-language sessions can be arranged when requested in advance."}, "talks": {"kicker": "01 / History", "title": "Lecture history", "sub": "Selected public and institutional engagements", "desc": "A selection of institutional lectures and workshops. Beyond these, I have also run many 1:1 tutorials and small-group sessions for individuals and teams.", "items": [{"year": "2026.09", "category": "Youth media", "title": "Media Career One-Day: Film Director Experience", "org": "Mapo Youth Center (시립마포청소년센터)", "role": "Instructor", "summary": "23 Sep 2026 · Hands-on media career session for upper-elementary students, focused on the role of a film director.", "href": ""}, {"year": "2025.11", "category": "Youth media", "title": "Dream Collaboration — Video Production Project with Media Professionals", "org": "Mapo Youth Center (시립마포청소년센터)", "role": "Instructor / Project lead", "summary": "27 Nov – 18 Dec 2025 · Multi-week video production project for middle and high school students.", "href": ""}, {"year": "2025.11", "category": "Youth media", "title": "Media Career One-Day: Film Director Experience", "org": "Mapo Youth Center (시립마포청소년센터)", "role": "Instructor", "summary": "4 Nov 2025 · One-day media career workshop for middle school students.", "href": ""}, {"year": "2025.10", "category": "Youth media", "title": "Media Career One-Day: Film Director Experience", "org": "Mapo Youth Center (시립마포청소년센터)", "role": "Instructor", "summary": "28 Oct 2025 · One-day media career workshop for middle school students.", "href": ""}, {"year": "2025.08", "category": "Scouting × AI", "title": "From Analog to AI Native: The Scout Path Built Across Generations", "org": "Korea Scout Association (한국스카우트연맹) — National Training Leaders Conference", "role": "Session lead", "summary": "30 Aug 2025 · Session lead at the National Training Leaders Conference (전국훈육지도자대회).", "href": ""}, {"year": "2025.07", "category": "Youth media", "title": "Media Career One-Day: Film Director Experience", "org": "Mapo Youth Center (시립마포청소년센터)", "role": "Instructor", "summary": "2 Jul 2025 · One-day media career workshop for middle school students.", "href": ""}, {"year": "2022.08", "category": "Scout media", "title": "Video Content Planning", "org": "Korea Scout Association (한국스카우트연맹) — 15th Scout Journalism School", "role": "Instructor", "summary": "20 Aug 2022 · Lecture on planning video content for middle and high school Scout journalists.", "href": ""}, {"year": "2021.03", "category": "University", "title": "Virtual Company — University Course (Co-taught)", "org": "Halla University (한라대학교) — Department of Media Advertising Content", "role": "University co-instructor (Hello Peace Lab)", "summary": "Spring semester 2021 · Semester-long university course for Halla University students (course name: Virtual Company; formerly Dept. of Advertising & Visual Media).", "href": ""}, {"year": "2021", "category": "Publication", "title": "Influencer, Becoming the Trend of the Era (1): Lecture Edition", "org": "Publication", "role": "Author", "summary": "2021 · Authored the lecture edition of the book on influencers and contemporary media trends.", "href": ""}, {"year": "2020.09", "category": "University", "title": "Virtual Company — University Course (Co-taught)", "org": "Halla University (한라대학교) — Department of Media Advertising Content", "role": "University co-instructor (Hello Peace Lab)", "summary": "Fall semester 2020 · Semester-long university course for Halla University students (course name: Virtual Company; formerly Dept. of Advertising & Visual Media).", "href": ""}, {"year": "2020.11", "category": "Small business", "title": "Mobile Video Editing for Small Business Owners", "org": "Jungnang Dongbu Market (중랑동부시장), Seoul", "role": "Instructor", "summary": "3–12 Nov 2020 · Mobile video editing training for market merchants and small business owners.", "href": ""}, {"year": "2018.12", "category": "Staff training", "title": "Photoshop for Educational Materials Development", "org": "Bucheon Children's & Social Welfare Foodservice Management Support Center (부천시어린이·사회복지급식관리지원센터)", "role": "Instructor", "summary": "20 Dec 2018 · Internal staff training on Photoshop for producing and developing educational materials (adult learners). Historical reference: Bucheon 2nd Children's Meal Support Center.", "href": ""}]}, "topics": {"kicker": "02 / Topics", "title": "Topics I can cover", "sub": "Formats from keynotes to hands-on labs", "desc": "Pick a theme below — or tell me what your audience needs. Public talks, workshops, university courses, and private coaching are all possible.", "items": [{"name": "Branded film & directing", "desc": "Story, craft and production for films and director-led sessions."}, {"name": "Youth media careers", "desc": "One-day and project-based programs for students exploring film and media work."}, {"name": "Applied AI / AI Native", "desc": "Practical AI for teams and organizations — including Scouting leadership contexts."}, {"name": "Scout media & communication", "desc": "Journalism school sessions and content planning for Scout communicators."}, {"name": "University media courses", "desc": "Semester teaching in advertising, media and content programs."}, {"name": "1:1 & small-group coaching", "desc": "Private and small-group sessions tailored to a brief, skill gap or project."}, {"name": "Creative tools for work", "desc": "Photoshop, mobile editing and production tools for educators and small business."}]}, "cta": {"title": "Want to invite a lecture or workshop?", "body": "Feel free to reach out with a rough idea — audience, date, language and format. I'll suggest a clear session shape and we can refine it together. Korean is standard; English is available with advance notice.", "button": {"label": "Ask about a lecture", "href": "/contact"}}};
function migrateTo25(doc) {
  if (!doc.pages) doc.pages = {};
  if (!doc.pages.lecture) doc.pages.lecture = JSON.parse(JSON.stringify(DEFAULT.pages.lecture));
  const lec = doc.pages.lecture;
  lec.meta = JSON.parse(JSON.stringify(V25_LECTURE_PAGE.meta));
  if (!lec.sections) lec.sections = {};
  lec.sections.intro = JSON.parse(JSON.stringify(V25_LECTURE_PAGE.intro));
  lec.sections.talks = JSON.parse(JSON.stringify(V25_LECTURE_PAGE.talks));
  lec.sections.topics = JSON.parse(JSON.stringify(V25_LECTURE_PAGE.topics));
  lec.sections.cta = JSON.parse(JSON.stringify(V25_LECTURE_PAGE.cta));
  doc.version = 25;
  return doc;
}
// v26: expand Global & Scouting timeline/roles from Jimmy's detailed Scouting history.
const V26_SCOUTING = {"timeline": {"title": "A life in Scouting. A practice in communication.", "note": "From joining in 2003 through jamboree media, international contingents, and Asia-Pacific leadership. Expand a year to see the full list.", "items": [{"year": "2003", "title": "Joined Scouting as a Scout", "context": "I started Scouting as a Scout, experiencing people and activities first-hand in the field.", "track": "Scout", "accent": "neutral"}, {"year": "2012", "title": "Bear Scout advancement No. 1420", "context": "Authorized as Bear Scout (범스카우트) No. 1420 — Korea’s top Scout rank.", "track": "Scout", "accent": "neutral"}, {"year": "2012", "title": "13th Korea Jamboree — Scout journalist", "context": "Participated as a Scout journalist (대원기자) at the 13th Korea Jamboree.", "track": "Scout", "accent": "neutral"}, {"year": "2014", "title": "Became a Scout Leader", "context": "I became a Scout Leader, moving into a role that guides and supports youth activities — built on my years as a Scout.", "track": "Leader", "accent": "green"}, {"year": "2014", "title": "1st CJK-B — Korean Contingent journalist", "context": "Attended the 1st China–Japan–Korea Scouting Friendship (CJK-B) as a journalist with the Korean Contingent.", "track": "Leader", "accent": "neutral"}, {"year": "2014", "title": "4th International Patrol Jamboree — newspaper design lead", "context": "Planning & Coordination HQ Media Center: lead for newspaper design.", "track": "Leader", "accent": "green"}, {"year": "2015", "title": "25th Asia-Pacific Scout Conference — PRESS video lead", "context": "Joined the PRESS media team and led the video unit.", "track": "Leader", "accent": "green"}, {"year": "2016", "title": "6th WSPU youth exchange — photography", "context": "Photography for the youth exchange and the National Assembly invitation roundtable.", "track": "Leader", "accent": "neutral"}, {"year": "2016", "title": "3rd CJK-B — Head of Korean Contingent", "context": "Attended the 3rd China–Japan–Korea Scouting Friendship (CJK-B) as Head of the Korean Contingent.", "track": "Leader", "accent": "green"}, {"year": "2016", "title": "14th Korea Jamboree — video team leader", "context": "Planning & Coordination HQ Media Center: video team leader.", "track": "Leader", "accent": "green"}, {"year": "2016–2017", "title": "25th World Scout Jamboree bid — working committee", "context": "Practical promotion committee member for the bid; youth lead covering the Arab region.", "track": "Leader", "accent": "neutral"}, {"year": "2016–2017", "title": "25th World Scout Jamboree bid — supporters team leader", "context": "Team leader of the Jamboree bid supporters group.", "track": "Leader", "accent": "green"}, {"year": "2016–2017", "title": "25th World Scout Jamboree bid — Brush Team deputy leader", "context": "Deputy team leader of the Brush Team during the bid campaign.", "track": "Leader", "accent": "neutral"}, {"year": "2017", "title": "Taiwan National Rover Scout Conference — observer", "context": "Joined the Korean observer delegation to the National Rover Scout Conference hosted by the Scout Association of Taiwan.", "track": "Leader", "accent": "neutral"}, {"year": "2017", "title": "Asia-Pacific Scout Foundation — Associate Member", "context": "Joined the Asia-Pacific Region Scout Support Foundation as an Associate Member.", "track": "Leader", "accent": "green"}, {"year": "2018", "title": "5th International Patrol Jamboree — design & archive lead", "context": "Planning & Coordination HQ Media Center: newspaper design and media archive lead.", "track": "Leader", "accent": "green"}, {"year": "2022–2024", "title": "National Commissioner, Korea Scout Association", "context": "Served as National Commissioner on PR II, working on domestic Scouting activity and communication.", "track": "Leader", "accent": "green"}, {"year": "2023", "title": "25th World Scout Jamboree — Korea Contingent media", "context": "Deputy Head of Media for the Korean Contingent at the 25th World Scout Jamboree.", "track": "Leader", "accent": "green"}, {"year": "2024", "title": "WE@FUTURE Jamboree — Head of Contingent", "context": "Head of Contingent at WE@FUTURE Jamboree, hosted by the Scout Association of Hong Kong.", "track": "Leader", "accent": "green"}, {"year": "2025", "title": "28th Asia-Pacific Scout Conference — voting delegate", "context": "Full (voting) delegate of the Korean Contingent to the 28th Asia-Pacific Scout Conference.", "track": "Leader", "accent": "green"}, {"year": "2025–2028", "title": "APR C&P Sub-Committee, 2nd Vice Chair", "context": "2nd Vice Chair of the Asia-Pacific Region Communications & Partnerships Sub-Committee.", "track": "Leader", "accent": "green"}, {"year": "2026", "title": "15th Korea Jamboree — Public Relations Director", "context": "Director of the Public Relations Department (홍보부 부장), Planning & Coordination HQ.", "track": "Leader", "accent": "green"}, {"year": "2026–", "title": "BP Media", "context": "I run BP Media, a Scouting-specialized media platform.", "track": "Leader", "accent": "green"}]}, "roles": {"title": "Roles behind the relationships", "items": [{"title": "APR Communication & Partnerships", "org": "2nd Vice Chair", "period": "2025–2028", "accent": "neutral"}, {"title": "National Commissioner on PR II", "org": "Korea Scout Association", "period": "2022–2024", "accent": "neutral"}, {"title": "Head of Contingent", "org": "WE@FUTURE Jamboree (Hong Kong)", "period": "2024", "accent": "neutral"}, {"title": "Deputy Head of Media · Korean Contingent", "org": "25th World Scout Jamboree", "period": "2023", "accent": "neutral"}, {"title": "Public Relations Director", "org": "15th Korea Jamboree · Planning & Coordination HQ", "period": "2026", "accent": "neutral"}, {"title": "BP Media", "org": "Founder", "period": "2026–", "accent": "green"}]}, "stats": {"items": [{"value": "20+ Years", "label": "Scouting experience"}, {"value": "Youth Movement", "label": "Growth & social impact"}, {"value": "International Exchange", "label": "Global network"}, {"value": "Media & Documentation", "label": "Records · communication"}]}};
...
// v27: Bear Scout date 2012-01-20; ATAS membership No. 3226 (2015).
const V27_SCOUTING_TIMELINE = {"title": "A life in Scouting. A practice in communication.", "note": "From joining in 2003 through jamboree media, international contingents, and Asia-Pacific leadership. Expand a year to see the full list.", "items": [{"year": "2003", "title": "Joined Scouting as a Scout", "context": "I started Scouting as a Scout, experiencing people and activities first-hand in the field.", "track": "Scout", "accent": "neutral"}, {"year": "2012.01", "title": "Bear Scout advancement No. 1420", "context": "Authorized as Bear Scout (범스카우트) No. 1420 on 20 January 2012 — Korea’s top Scout rank.", "track": "Scout", "accent": "neutral"}, {"year": "2012", "title": "13th Korea Jamboree — Scout journalist", "context": "Participated as a Scout journalist (대원기자) at the 13th Korea Jamboree.", "track": "Scout", "accent": "neutral"}, {"year": "2014", "title": "Became a Scout Leader", "context": "I became a Scout Leader, moving into a role that guides and supports youth activities — built on my years as a Scout.", "track": "Leader", "accent": "green"}, {"year": "2014", "title": "1st CJK-B — Korean Contingent journalist", "context": "Attended the 1st China–Japan–Korea Scouting Friendship (CJK-B) as a journalist with the Korean Contingent.", "track": "Leader", "accent": "neutral"}, {"year": "2014", "title": "4th International Patrol Jamboree — newspaper design lead", "context": "Planning & Coordination HQ Media Center: lead for newspaper design.", "track": "Leader", "accent": "green"}, {"year": "2015", "title": "25th Asia-Pacific Scout Conference — PRESS video lead", "context": "Joined the PRESS media team and led the video unit.", "track": "Leader", "accent": "green"}, {"year": "2015", "title": "ATAS membership No. 3226", "context": "Joined ATAS in 2015 (membership No. 3226).", "track": "Leader", "accent": "neutral"}, {"year": "2016", "title": "6th WSPU youth exchange — photography", "context": "Photography for the youth exchange and the National Assembly invitation roundtable.", "track": "Leader", "accent": "neutral"}, {"year": "2016", "title": "3rd CJK-B — Head of Korean Contingent", "context": "Attended the 3rd China–Japan–Korea Scouting Friendship (CJK-B) as Head of the Korean Contingent.", "track": "Leader", "accent": "green"}, {"year": "2016", "title": "14th Korea Jamboree — video team leader", "context": "Planning & Coordination HQ Media Center: video team leader.", "track": "Leader", "accent": "green"}, {"year": "2016–2017", "title": "25th World Scout Jamboree bid — working committee", "context": "Practical promotion committee member for the bid; youth lead covering the Arab region.", "track": "Leader", "accent": "neutral"}, {"year": "2016–2017", "title": "25th World Scout Jamboree bid — supporters team leader", "context": "Team leader of the Jamboree bid supporters group.", "track": "Leader", "accent": "green"}, {"year": "2016–2017", "title": "25th World Scout Jamboree bid — Brush Team deputy leader", "context": "Deputy team leader of the Brush Team during the bid campaign.", "track": "Leader", "accent": "neutral"}, {"year": "2017", "title": "Taiwan National Rover Scout Conference — observer", "context": "Joined the Korean observer delegation to the National Rover Scout Conference hosted by the Scout Association of Taiwan.", "track": "Leader", "accent": "neutral"}, {"year": "2017", "title": "Asia-Pacific Scout Foundation — Associate Member", "context": "Joined the Asia-Pacific Region Scout Support Foundation as an Associate Member.", "track": "Leader", "accent": "green"}, {"year": "2018", "title": "5th International Patrol Jamboree — design & archive lead", "context": "Planning & Coordination HQ Media Center: newspaper design and media archive lead.", "track": "Leader", "accent": "green"}, {"year": "2022–2024", "title": "National Commissioner, Korea Scout Association", "context": "Served as National Commissioner on PR II, working on domestic Scouting activity and communication.", "track": "Leader", "accent": "green"}, {"year": "2023", "title": "25th World Scout Jamboree — Korea Contingent media", "context": "Deputy Head of Media for the Korean Contingent at the 25th World Scout Jamboree.", "track": "Leader", "accent": "green"}, {"year": "2024", "title": "WE@FUTURE Jamboree — Head of Contingent", "context": "Head of Contingent at WE@FUTURE Jamboree, hosted by the Scout Association of Hong Kong.", "track": "Leader", "accent": "green"}, {"year": "2025", "title": "28th Asia-Pacific Scout Conference — voting delegate", "context": "Full (voting) delegate of the Korean Contingent to the 28th Asia-Pacific Scout Conference.", "track": "Leader", "accent": "green"}, {"year": "2025–2028", "title": "APR C&P Sub-Committee, 2nd Vice Chair", "context": "2nd Vice Chair of the Asia-Pacific Region Communications & Partnerships Sub-Committee.", "track": "Leader", "accent": "green"}, {"year": "2026", "title": "15th Korea Jamboree — Public Relations Director", "context": "Director of the Public Relations Department (홍보부 부장), Planning & Coordination HQ.", "track": "Leader", "accent": "green"}, {"year": "2026–", "title": "BP Media", "context": "I run BP Media, a Scouting-specialized media platform.", "track": "Leader", "accent": "green"}, {"year": "2026–", "title": "Scouting web experiments", "context": "I experiment with web projects such as Scout Tour Assistant to make Scouting places and information easier to explore.", "track": "Leader", "accent": "green"}]};
function migrateTo27(doc) {
  const sc = doc.pages && doc.pages.scouting && doc.pages.scouting.sections;
  if (sc) sc.timeline = JSON.parse(JSON.stringify(V27_SCOUTING_TIMELINE));
  doc.version = 27;
  return doc;
}
// v28: ATAS full name; Future Value Committee / Vision 2032 (2024–2025).
const V28_SCOUTING = {"timeline": {"title": "A life in Scouting. A practice in communication.", "note": "From joining in 2003 through jamboree media, international contingents, and Asia-Pacific leadership. Expand a year to see the full list.", "items": [{"year": "2003", "title": "Joined Scouting as a Scout", "context": "I started Scouting as a Scout, experiencing people and activities first-hand in the field.", "track": "Scout", "accent": "neutral"}, {"year": "2012.01", "title": "Bear Scout advancement No. 1420", "context": "Authorized as Bear Scout (범스카우트) No. 1420 on 20 January 2012 — Korea’s top Scout rank.", "track": "Scout", "accent": "neutral"}, {"year": "2012", "title": "13th Korea Jamboree — Scout journalist", "context": "Participated as a Scout journalist (대원기자) at the 13th Korea Jamboree.", "track": "Scout", "accent": "neutral"}, {"year": "2014", "title": "Became a Scout Leader", "context": "I became a Scout Leader, moving into a role that guides and supports youth activities — built on my years as a Scout.", "track": "Leader", "accent": "green"}, {"year": "2014", "title": "1st CJK-B — Korean Contingent journalist", "context": "Attended the 1st China–Japan–Korea Scouting Friendship (CJK-B) as a journalist with the Korean Contingent.", "track": "Leader", "accent": "neutral"}, {"year": "2014", "title": "4th International Patrol Jamboree — newspaper design lead", "context": "Planning & Coordination HQ Media Center: lead for newspaper design.", "track": "Leader", "accent": "green"}, {"year": "2015", "title": "25th Asia-Pacific Scout Conference — PRESS video lead", "context": "Joined the PRESS media team and led the video unit.", "track": "Leader", "accent": "green"}, {"year": "2015", "title": "ATAS membership No. 3226", "context": "Joined the Association of Top Achiever Scouts (ATAS) in 2015 (membership No. 3226).", "track": "Leader", "accent": "neutral"}, {"year": "2016", "title": "6th WSPU youth exchange — photography", "context": "Photography for the youth exchange and the National Assembly invitation roundtable.", "track": "Leader", "accent": "neutral"}, {"year": "2016", "title": "3rd CJK-B — Head of Korean Contingent", "context": "Attended the 3rd China–Japan–Korea Scouting Friendship (CJK-B) as Head of the Korean Contingent.", "track": "Leader", "accent": "green"}, {"year": "2016", "title": "14th Korea Jamboree — video team leader", "context": "Planning & Coordination HQ Media Center: video team leader.", "track": "Leader", "accent": "green"}, {"year": "2016–2017", "title": "25th World Scout Jamboree bid — working committee", "context": "Practical promotion committee member for the bid; youth lead covering the Arab region.", "track": "Leader", "accent": "neutral"}, {"year": "2016–2017", "title": "25th World Scout Jamboree bid — supporters team leader", "context": "Team leader of the Jamboree bid supporters group.", "track": "Leader", "accent": "green"}, {"year": "2016–2017", "title": "25th World Scout Jamboree bid — Brush Team deputy leader", "context": "Deputy team leader of the Brush Team during the bid campaign.", "track": "Leader", "accent": "neutral"}, {"year": "2017", "title": "Taiwan National Rover Scout Conference — observer", "context": "Joined the Korean observer delegation to the National Rover Scout Conference hosted by the Scout Association of Taiwan.", "track": "Leader", "accent": "neutral"}, {"year": "2017", "title": "Asia-Pacific Scout Foundation — Associate Member", "context": "Joined the Asia-Pacific Region Scout Support Foundation as an Associate Member.", "track": "Leader", "accent": "green"}, {"year": "2018", "title": "5th International Patrol Jamboree — design & archive lead", "context": "Planning & Coordination HQ Media Center: newspaper design and media archive lead.", "track": "Leader", "accent": "green"}, {"year": "2022–2024", "title": "National Commissioner, Korea Scout Association", "context": "Served as National Commissioner on PR II, working on domestic Scouting activity and communication.", "track": "Leader", "accent": "green"}, {"year": "2023", "title": "25th World Scout Jamboree — Korea Contingent media", "context": "Deputy Head of Media for the Korean Contingent at the 25th World Scout Jamboree.", "track": "Leader", "accent": "green"}, {"year": "2024", "title": "WE@FUTURE Jamboree — Head of Contingent", "context": "Head of Contingent at WE@FUTURE Jamboree, hosted by the Scout Association of Hong Kong.", "track": "Leader", "accent": "green"}, {"year": "2024–2025", "title": "Future Value Committee — subcommittee chair", "context": "Served as a subcommittee chair of the Korea Scout Association Future Value Committee (미래가치위원회) and helped shape Vision 2032.", "track": "Leader", "accent": "green"}, {"year": "2025", "title": "28th Asia-Pacific Scout Conference — voting delegate", "context": "Full (voting) delegate of the Korean Contingent to the 28th Asia-Pacific Scout Conference.", "track": "Leader", "accent": "green"}, {"year": "2025–2028", "title": "APR C&P Sub-Committee, 2nd Vice Chair", "context": "2nd Vice Chair of the Asia-Pacific Region Communications & Partnerships Sub-Committee.", "track": "Leader", "accent": "green"}, {"year": "2026", "title": "15th Korea Jamboree — Public Relations Director", "context": "Director of the Public Relations Department (홍보부 부장), Planning & Coordination HQ.", "track": "Leader", "accent": "green"}, {"year": "2026–", "title": "BP Media", "context": "I run BP Media, a Scouting-specialized media platform.", "track": "Leader", "accent": "green"}, {"year": "2026–", "title": "Scouting web experiments", "context": "I experiment with web projects such as Scout Tour Assistant to make Scouting places and information easier to explore.", "track": "Leader", "accent": "green"}]}, "roles": {"title": "Roles behind the relationships", "items": [{"title": "APR Communication & Partnerships", "org": "2nd Vice Chair", "period": "2025–2028", "accent": "neutral"}, {"title": "National Commissioner on PR II", "org": "Korea Scout Association", "period": "2022–2024", "accent": "neutral"}, {"title": "Future Value Committee — subcommittee chair", "org": "Korea Scout Association · Vision 2032", "period": "2024–2025", "accent": "neutral"}, {"title": "Head of Contingent", "org": "WE@FUTURE Jamboree (Hong Kong)", "period": "2024", "accent": "neutral"}, {"title": "Deputy Head of Media · Korean Contingent", "org": "25th World Scout Jamboree", "period": "2023", "accent": "neutral"}, {"title": "Public Relations Director", "org": "15th Korea Jamboree · Planning & Coordination HQ", "period": "2026", "accent": "neutral"}, {"title": "BP Media", "org": "Founder", "period": "2026–", "accent": "green"}]}};
function migrateTo28(doc) {
  const sc = doc.pages && doc.pages.scouting && doc.pages.scouting.sections;
  if (sc) {
    sc.timeline = JSON.parse(JSON.stringify(V28_SCOUTING.timeline));
    sc.roles = JSON.parse(JSON.stringify(V28_SCOUTING.roles));
  }
  doc.version = 28;
  return doc;
}
// v29: remove Scouting web experiments timeline entry.
const V29_SCOUTING_TIMELINE = {"title": "A life in Scouting. A practice in communication.", "note": "From joining in 2003 through jamboree media, international contingents, and Asia-Pacific leadership. Expand a year to see the full list.", "items": [{"year": "2003", "title": "Joined Scouting as a Scout", "context": "I started Scouting as a Scout, experiencing people and activities first-hand in the field.", "track": "Scout", "accent": "neutral"}, {"year": "2012.01", "title": "Bear Scout advancement No. 1420", "context": "Authorized as Bear Scout (범스카우트) No. 1420 on 20 January 2012 — Korea’s top Scout rank.", "track": "Scout", "accent": "neutral"}, {"year": "2012", "title": "13th Korea Jamboree — Scout journalist", "context": "Participated as a Scout journalist (대원기자) at the 13th Korea Jamboree.", "track": "Scout", "accent": "neutral"}, {"year": "2014", "title": "Became a Scout Leader", "context": "I became a Scout Leader, moving into a role that guides and supports youth activities — built on my years as a Scout.", "track": "Leader", "accent": "green"}, {"year": "2014", "title": "1st CJK-B — Korean Contingent journalist", "context": "Attended the 1st China–Japan–Korea Scouting Friendship (CJK-B) as a journalist with the Korean Contingent.", "track": "Leader", "accent": "neutral"}, {"year": "2014", "title": "4th International Patrol Jamboree — newspaper design lead", "context": "Planning & Coordination HQ Media Center: lead for newspaper design.", "track": "Leader", "accent": "green"}, {"year": "2015", "title": "25th Asia-Pacific Scout Conference — PRESS video lead", "context": "Joined the PRESS media team and led the video unit.", "track": "Leader", "accent": "green"}, {"year": "2015", "title": "ATAS membership No. 3226", "context": "Joined the Association of Top Achiever Scouts (ATAS) in 2015 (membership No. 3226).", "track": "Leader", "accent": "neutral"}, {"year": "2016", "title": "6th WSPU youth exchange — photography", "context": "Photography for the youth exchange and the National Assembly invitation roundtable.", "track": "Leader", "accent": "neutral"}, {"year": "2016", "title": "3rd CJK-B — Head of Korean Contingent", "context": "Attended the 3rd China–Japan–Korea Scouting Friendship (CJK-B) as Head of the Korean Contingent.", "track": "Leader", "accent": "green"}, {"year": "2016", "title": "14th Korea Jamboree — video team leader", "context": "Planning & Coordination HQ Media Center: video team leader.", "track": "Leader", "accent": "green"}, {"year": "2016–2017", "title": "25th World Scout Jamboree bid — working committee", "context": "Practical promotion committee member for the bid; youth lead covering the Arab region.", "track": "Leader", "accent": "neutral"}, {"year": "2016–2017", "title": "25th World Scout Jamboree bid — supporters team leader", "context": "Team leader of the Jamboree bid supporters group.", "track": "Leader", "accent": "green"}, {"year": "2016–2017", "title": "25th World Scout Jamboree bid — Brush Team deputy leader", "context": "Deputy team leader of the Brush Team during the bid campaign.", "track": "Leader", "accent": "neutral"}, {"year": "2017", "title": "Taiwan National Rover Scout Conference — observer", "context": "Joined the Korean observer delegation to the National Rover Scout Conference hosted by the Scout Association of Taiwan.", "track": "Leader", "accent": "neutral"}, {"year": "2017", "title": "Asia-Pacific Scout Foundation — Associate Member", "context": "Joined the Asia-Pacific Region Scout Support Foundation as an Associate Member.", "track": "Leader", "accent": "green"}, {"year": "2018", "title": "5th International Patrol Jamboree — design & archive lead", "context": "Planning & Coordination HQ Media Center: newspaper design and media archive lead.", "track": "Leader", "accent": "green"}, {"year": "2022–2024", "title": "National Commissioner, Korea Scout Association", "context": "Served as National Commissioner on PR II, working on domestic Scouting activity and communication.", "track": "Leader", "accent": "green"}, {"year": "2023", "title": "25th World Scout Jamboree — Korea Contingent media", "context": "Deputy Head of Media for the Korean Contingent at the 25th World Scout Jamboree.", "track": "Leader", "accent": "green"}, {"year": "2024", "title": "WE@FUTURE Jamboree — Head of Contingent", "context": "Head of Contingent at WE@FUTURE Jamboree, hosted by the Scout Association of Hong Kong.", "track": "Leader", "accent": "green"}, {"year": "2024–2025", "title": "Future Value Committee — subcommittee chair", "context": "Served as a subcommittee chair of the Korea Scout Association Future Value Committee (미래가치위원회) and helped shape Vision 2032.", "track": "Leader", "accent": "green"}, {"year": "2025", "title": "28th Asia-Pacific Scout Conference — voting delegate", "context": "Full (voting) delegate of the Korean Contingent to the 28th Asia-Pacific Scout Conference.", "track": "Leader", "accent": "green"}, {"year": "2025–2028", "title": "APR C&P Sub-Committee, 2nd Vice Chair", "context": "2nd Vice Chair of the Asia-Pacific Region Communications & Partnerships Sub-Committee.", "track": "Leader", "accent": "green"}, {"year": "2026", "title": "15th Korea Jamboree — Public Relations Director", "context": "Director of the Public Relations Department (홍보부 부장), Planning & Coordination HQ.", "track": "Leader", "accent": "green"}, {"year": "2026–", "title": "BP Media", "context": "I run BP Media, a Scouting-specialized media platform.", "track": "Leader", "accent": "green"}]};
function migrateTo29(doc) {
  const sc = doc.pages && doc.pages.scouting && doc.pages.scouting.sections;
  if (sc) sc.timeline = JSON.parse(JSON.stringify(V29_SCOUTING_TIMELINE));
  doc.version = 29;
  return doc;
}
// v30: awards, training, unit leader, journalism school, digital camporee.
const V30_SCOUTING = {"timeline": {"title": "A life in Scouting. A practice in communication.", "note": "From joining in 2003 through jamboree media, international contingents, and Asia-Pacific leadership. Expand a year to see the full list.", "items": [{"year": "2003", "title": "Joined Scouting as a Scout", "context": "I started Scouting as a Scout, experiencing people and activities first-hand in the field.", "track": "Scout", "accent": "neutral"}, {"year": "2012", "title": "13th Korea Jamboree — Scout journalist", "context": "Participated as a Scout journalist (대원기자) at the 13th Korea Jamboree.", "track": "Scout", "accent": "neutral"}, {"year": "2012.01", "title": "Bear Scout advancement No. 1420", "context": "Authorized as Bear Scout (범스카우트) No. 1420 on 20 January 2012 — Korea’s top Scout rank.", "track": "Scout", "accent": "neutral"}, {"year": "2014", "title": "1st CJK-B — Korean Contingent journalist", "context": "Attended the 1st China–Japan–Korea Scouting Friendship (CJK-B) as a journalist with the Korean Contingent.", "track": "Leader", "accent": "neutral"}, {"year": "2014", "title": "4th International Patrol Jamboree — newspaper design lead", "context": "Planning & Coordination HQ Media Center: lead for newspaper design.", "track": "Leader", "accent": "green"}, {"year": "2014", "title": "6th Scout Journalism School — instructor", "context": "Instructor for the “I Am Also a Journalist” (나도저널리스트) program at the 6th Scout Journalism School.", "track": "Leader", "accent": "green"}, {"year": "2014", "title": "Became a Scout Leader", "context": "I became a Scout Leader, moving into a role that guides and supports youth activities — built on my years as a Scout.", "track": "Leader", "accent": "green"}, {"year": "2014", "title": "Intermediate Scout training completed", "context": "Completed Korea Scout Association intermediate training (중급훈련).", "track": "Leader", "accent": "neutral"}, {"year": "2015", "title": "25th Asia-Pacific Scout Conference — PRESS video lead", "context": "Joined the PRESS media team and led the video unit.", "track": "Leader", "accent": "green"}, {"year": "2015", "title": "ATAS membership No. 3226", "context": "Joined the Association of Top Achiever Scouts (ATAS) in 2015 (membership No. 3226).", "track": "Leader", "accent": "neutral"}, {"year": "2015", "title": "Advanced Scout course completed", "context": "Completed Korea Scout Association advanced course (상급과정).", "track": "Leader", "accent": "neutral"}, {"year": "2016", "title": "14th Korea Jamboree — video team leader", "context": "Planning & Coordination HQ Media Center: video team leader.", "track": "Leader", "accent": "green"}, {"year": "2016–2017", "title": "25th World Scout Jamboree bid — Brush Team deputy leader", "context": "Deputy team leader of the Brush Team during the bid campaign.", "track": "Leader", "accent": "neutral"}, {"year": "2016–2017", "title": "25th World Scout Jamboree bid — supporters team leader", "context": "Team leader of the Jamboree bid supporters group.", "track": "Leader", "accent": "green"}, {"year": "2016–2017", "title": "25th World Scout Jamboree bid — working committee", "context": "Practical promotion committee member for the bid; youth lead covering the Arab region.", "track": "Leader", "accent": "neutral"}, {"year": "2016", "title": "3rd CJK-B — Head of Korean Contingent", "context": "Attended the 3rd China–Japan–Korea Scouting Friendship (CJK-B) as Head of the Korean Contingent.", "track": "Leader", "accent": "green"}, {"year": "2016", "title": "6th WSPU youth exchange — photography", "context": "Photography for the youth exchange and the National Assembly invitation roundtable.", "track": "Leader", "accent": "neutral"}, {"year": "2016.08", "title": "Scout Journalism School — instructor", "context": "Instructor at the Scout Journalism School (August 2016).", "track": "Leader", "accent": "green"}, {"year": "2017", "title": "Asia-Pacific Scout Foundation — Associate Member", "context": "Joined the Asia-Pacific Region Scout Support Foundation as an Associate Member.", "track": "Leader", "accent": "green"}, {"year": "2017", "title": "International Service Award", "context": "Received the Korea Scout Association International Service Award.", "track": "Leader", "accent": "green"}, {"year": "2017", "title": "Korea Scout Association Citation Badge", "context": "Received the Korea Scout Association commendation badge (표창 기장).", "track": "Leader", "accent": "neutral"}, {"year": "2017", "title": "Taiwan National Rover Scout Conference — observer", "context": "Joined the Korean observer delegation to the National Rover Scout Conference hosted by the Scout Association of Taiwan.", "track": "Leader", "accent": "neutral"}, {"year": "2017.03", "title": "1st Scout Youth Mock National Assembly — mentor", "context": "Mentored at the 1st Scout Youth Mock National Assembly (스카우트 청소년모의국회).", "track": "Leader", "accent": "neutral"}, {"year": "2017.08–2019.01", "title": "Uniform & Equipment Committee member", "context": "Member of the Korea Scout Association Uniform and Equipment Committee (제복장구위원회).", "track": "Leader", "accent": "neutral"}, {"year": "2018", "title": "5th International Patrol Jamboree — design & archive lead", "context": "Planning & Coordination HQ Media Center: newspaper design and media archive lead.", "track": "Leader", "accent": "green"}, {"year": "2018", "title": "President’s Citation, Korea Scout Association", "context": "Received the Korea Scout Association President’s Citation (총재 표창).", "track": "Leader", "accent": "green"}, {"year": "2018.03", "title": "2nd Scout Youth Mock National Assembly — mentor", "context": "Mentored at the 2nd Scout Youth Mock National Assembly.", "track": "Leader", "accent": "neutral"}, {"year": "2019.08", "title": "12th Scout Journalism School — photography instructor", "context": "Photography practical instructor at the 12th Scout Journalism School.", "track": "Leader", "accent": "green"}, {"year": "2020", "title": "Mugunghwa Bronze Medal", "context": "Awarded the Korea Scout Association Mugunghwa Bronze Medal (무궁화 동장).", "track": "Leader", "accent": "green"}, {"year": "2022", "title": "2nd World Digital Camporee — Marketing Director", "context": "Served as Marketing Headquarters Director for the 2nd World Digital Camporee (세계디지털야영대회).", "track": "Leader", "accent": "green"}, {"year": "2022", "title": "Commissioner Course completed", "context": "Completed the Korea Scout Association Commissioner Course (커미셔너과정).", "track": "Leader", "accent": "neutral"}, {"year": "2022–2024", "title": "National Commissioner, Korea Scout Association", "context": "Served as National Commissioner on PR II, working on domestic Scouting activity and communication.", "track": "Leader", "accent": "green"}, {"year": "2022", "title": "Wood Badge completed", "context": "Completed Wood Badge qualification.", "track": "Leader", "accent": "green"}, {"year": "2023", "title": "25th World Scout Jamboree — Korea Contingent media", "context": "Deputy Head of Media for the Korean Contingent at the 25th World Scout Jamboree.", "track": "Leader", "accent": "green"}, {"year": "2024–2025", "title": "Future Value Committee — subcommittee chair", "context": "Served as a subcommittee chair of the Korea Scout Association Future Value Committee (미래가치위원회) and helped shape Vision 2032.", "track": "Leader", "accent": "green"}, {"year": "2024", "title": "WE@FUTURE Jamboree — Head of Contingent", "context": "Head of Contingent at WE@FUTURE Jamboree, hosted by the Scout Association of Hong Kong.", "track": "Leader", "accent": "green"}, {"year": "2024.01–", "title": "Unit Leader, Baengnyong Dongwoo Unit", "context": "Unit Leader (단대장) of Baengnyong Dongwoo Unit, Gyeonggi Southern Federation, Korea Scout Association — ongoing since January 2024.", "track": "Leader", "accent": "green"}, {"year": "2025", "title": "28th Asia-Pacific Scout Conference — voting delegate", "context": "Full (voting) delegate of the Korean Contingent to the 28th Asia-Pacific Scout Conference.", "track": "Leader", "accent": "green"}, {"year": "2025–2028", "title": "APR C&P Sub-Committee, 2nd Vice Chair", "context": "2nd Vice Chair of the Asia-Pacific Region Communications & Partnerships Sub-Committee.", "track": "Leader", "accent": "green"}, {"year": "2025", "title": "Mugunghwa Silver Medal", "context": "Awarded the Korea Scout Association Mugunghwa Silver Medal (무궁화 은장).", "track": "Leader", "accent": "green"}, {"year": "2026", "title": "15th Korea Jamboree — Public Relations Director", "context": "Director of the Public Relations Department (홍보부 부장), Planning & Coordination HQ.", "track": "Leader", "accent": "green"}, {"year": "2026–", "title": "BP Media", "context": "I run BP Media, a Scouting-specialized media platform.", "track": "Leader", "accent": "green"}]}, "roles": {"title": "Roles behind the relationships", "items": [{"title": "Unit Leader · Baengnyong Dongwoo Unit", "org": "Gyeonggi Southern Federation, KSA", "period": "2024.01–", "accent": "green"}, {"title": "APR Communication & Partnerships", "org": "2nd Vice Chair", "period": "2025–2028", "accent": "neutral"}, {"title": "National Commissioner on PR II", "org": "Korea Scout Association", "period": "2022–2024", "accent": "neutral"}, {"title": "Future Value Committee — subcommittee chair", "org": "Korea Scout Association · Vision 2032", "period": "2024–2025", "accent": "neutral"}, {"title": "Head of Contingent", "org": "WE@FUTURE Jamboree (Hong Kong)", "period": "2024", "accent": "neutral"}, {"title": "Deputy Head of Media · Korean Contingent", "org": "25th World Scout Jamboree", "period": "2023", "accent": "neutral"}, {"title": "Public Relations Director", "org": "15th Korea Jamboree · Planning & Coordination HQ", "period": "2026", "accent": "neutral"}, {"title": "BP Media", "org": "Founder", "period": "2026–", "accent": "green"}, {"title": "Mugunghwa Silver Medal", "org": "Korea Scout Association", "period": "2025", "accent": "neutral"}]}};
function migrateTo30(doc) {
  const sc = doc.pages && doc.pages.scouting && doc.pages.scouting.sections;
  if (sc) {
    sc.timeline = JSON.parse(JSON.stringify(V30_SCOUTING.timeline));
    sc.roles = JSON.parse(JSON.stringify(V30_SCOUTING.roles));
  }
  doc.version = 30;
  return doc;
}
// v31: year-accordion UI support; 2016 journalism school = 8th.
const V31_SCOUTING_TIMELINE = {"title": "A life in Scouting. A practice in communication.", "note": "From joining in 2003 through jamboree media, international contingents, and Asia-Pacific leadership. Expand a year to see the full list.", "items": [{"year": "2003", "title": "Joined Scouting as a Scout", "context": "I started Scouting as a Scout, experiencing people and activities first-hand in the field.", "track": "Scout", "accent": "neutral"}, {"year": "2012", "title": "13th Korea Jamboree — Scout journalist", "context": "Participated as a Scout journalist (대원기자) at the 13th Korea Jamboree.", "track": "Scout", "accent": "neutral"}, {"year": "2012.01", "title": "Bear Scout advancement No. 1420", "context": "Authorized as Bear Scout (범스카우트) No. 1420 on 20 January 2012 — Korea’s top Scout rank.", "track": "Scout", "accent": "neutral"}, {"year": "2014", "title": "1st CJK-B — Korean Contingent journalist", "context": "Attended the 1st China–Japan–Korea Scouting Friendship (CJK-B) as a journalist with the Korean Contingent.", "track": "Leader", "accent": "neutral"}, {"year": "2014", "title": "4th International Patrol Jamboree — newspaper design lead", "context": "Planning & Coordination HQ Media Center: lead for newspaper design.", "track": "Leader", "accent": "green"}, {"year": "2014", "title": "6th Scout Journalism School — instructor", "context": "Instructor for the “I Am Also a Journalist” (나도저널리스트) program at the 6th Scout Journalism School.", "track": "Leader", "accent": "green"}, {"year": "2014", "title": "Became a Scout Leader", "context": "I became a Scout Leader, moving into a role that guides and supports youth activities — built on my years as a Scout.", "track": "Leader", "accent": "green"}, {"year": "2014", "title": "Intermediate Scout training completed", "context": "Completed Korea Scout Association intermediate training (중급훈련).", "track": "Leader", "accent": "neutral"}, {"year": "2015", "title": "25th Asia-Pacific Scout Conference — PRESS video lead", "context": "Joined the PRESS media team and led the video unit.", "track": "Leader", "accent": "green"}, {"year": "2015", "title": "ATAS membership No. 3226", "context": "Joined the Association of Top Achiever Scouts (ATAS) in 2015 (membership No. 3226).", "track": "Leader", "accent": "neutral"}, {"year": "2015", "title": "Advanced Scout course completed", "context": "Completed Korea Scout Association advanced course (상급과정).", "track": "Leader", "accent": "neutral"}, {"year": "2016", "title": "14th Korea Jamboree — video team leader", "context": "Planning & Coordination HQ Media Center: video team leader.", "track": "Leader", "accent": "green"}, {"year": "2016–2017", "title": "25th World Scout Jamboree bid — Brush Team deputy leader", "context": "Deputy team leader of the Brush Team during the bid campaign.", "track": "Leader", "accent": "neutral"}, {"year": "2016–2017", "title": "25th World Scout Jamboree bid — supporters team leader", "context": "Team leader of the Jamboree bid supporters group.", "track": "Leader", "accent": "green"}, {"year": "2016–2017", "title": "25th World Scout Jamboree bid — working committee", "context": "Practical promotion committee member for the bid; youth lead covering the Arab region.", "track": "Leader", "accent": "neutral"}, {"year": "2016", "title": "3rd CJK-B — Head of Korean Contingent", "context": "Attended the 3rd China–Japan–Korea Scouting Friendship (CJK-B) as Head of the Korean Contingent.", "track": "Leader", "accent": "green"}, {"year": "2016", "title": "6th WSPU youth exchange — photography", "context": "Photography for the youth exchange and the National Assembly invitation roundtable.", "track": "Leader", "accent": "neutral"}, {"year": "2016.08", "title": "8th Scout Journalism School — instructor", "context": "Instructor at the 8th Scout Journalism School (August 2016).", "track": "Leader", "accent": "green"}, {"year": "2017", "title": "Asia-Pacific Scout Foundation — Associate Member", "context": "Joined the Asia-Pacific Region Scout Support Foundation as an Associate Member.", "track": "Leader", "accent": "green"}, {"year": "2017", "title": "International Service Award", "context": "Received the Korea Scout Association International Service Award.", "track": "Leader", "accent": "green"}, {"year": "2017", "title": "Korea Scout Association Citation Badge", "context": "Received the Korea Scout Association commendation badge (표창 기장).", "track": "Leader", "accent": "neutral"}, {"year": "2017", "title": "Taiwan National Rover Scout Conference — observer", "context": "Joined the Korean observer delegation to the National Rover Scout Conference hosted by the Scout Association of Taiwan.", "track": "Leader", "accent": "neutral"}, {"year": "2017.03", "title": "1st Scout Youth Mock National Assembly — mentor", "context": "Mentored at the 1st Scout Youth Mock National Assembly (스카우트 청소년모의국회).", "track": "Leader", "accent": "neutral"}, {"year": "2017.08–2019.01", "title": "Uniform & Equipment Committee member", "context": "Member of the Korea Scout Association Uniform and Equipment Committee (제복장구위원회).", "track": "Leader", "accent": "neutral"}, {"year": "2018", "title": "5th International Patrol Jamboree — design & archive lead", "context": "Planning & Coordination HQ Media Center: newspaper design and media archive lead.", "track": "Leader", "accent": "green"}, {"year": "2018", "title": "President’s Citation, Korea Scout Association", "context": "Received the Korea Scout Association President’s Citation (총재 표창).", "track": "Leader", "accent": "green"}, {"year": "2018.03", "title": "2nd Scout Youth Mock National Assembly — mentor", "context": "Mentored at the 2nd Scout Youth Mock National Assembly.", "track": "Leader", "accent": "neutral"}, {"year": "2019.08", "title": "12th Scout Journalism School — photography instructor", "context": "Photography practical instructor at the 12th Scout Journalism School.", "track": "Leader", "accent": "green"}, {"year": "2020", "title": "Mugunghwa Bronze Medal", "context": "Awarded the Korea Scout Association Mugunghwa Bronze Medal (무궁화 동장).", "track": "Leader", "accent": "green"}, {"year": "2022", "title": "2nd World Digital Camporee — Marketing Director", "context": "Served as Marketing Headquarters Director for the 2nd World Digital Camporee (세계디지털야영대회).", "track": "Leader", "accent": "green"}, {"year": "2022", "title": "Commissioner Course completed", "context": "Completed the Korea Scout Association Commissioner Course (커미셔너과정).", "track": "Leader", "accent": "neutral"}, {"year": "2022–2024", "title": "National Commissioner, Korea Scout Association", "context": "Served as National Commissioner on PR II, working on domestic Scouting activity and communication.", "track": "Leader", "accent": "green"}, {"year": "2022", "title": "Wood Badge completed", "context": "Completed Wood Badge qualification.", "track": "Leader", "accent": "green"}, {"year": "2023", "title": "25th World Scout Jamboree — Korea Contingent media", "context": "Deputy Head of Media for the Korean Contingent at the 25th World Scout Jamboree.", "track": "Leader", "accent": "green"}, {"year": "2024–2025", "title": "Future Value Committee — subcommittee chair", "context": "Served as a subcommittee chair of the Korea Scout Association Future Value Committee (미래가치위원회) and helped shape Vision 2032.", "track": "Leader", "accent": "green"}, {"year": "2024", "title": "WE@FUTURE Jamboree — Head of Contingent", "context": "Head of Contingent at WE@FUTURE Jamboree, hosted by the Scout Association of Hong Kong.", "track": "Leader", "accent": "green"}, {"year": "2024.01–", "title": "Unit Leader, Baengnyong Dongwoo Unit", "context": "Unit Leader (단대장) of Baengnyong Dongwoo Unit, Gyeonggi Southern Federation, Korea Scout Association — ongoing since January 2024.", "track": "Leader", "accent": "green"}, {"year": "2025", "title": "28th Asia-Pacific Scout Conference — voting delegate", "context": "Full (voting) delegate of the Korean Contingent to the 28th Asia-Pacific Scout Conference.", "track": "Leader", "accent": "green"}, {"year": "2025–2028", "title": "APR C&P Sub-Committee, 2nd Vice Chair", "context": "2nd Vice Chair of the Asia-Pacific Region Communications & Partnerships Sub-Committee.", "track": "Leader", "accent": "green"}, {"year": "2025", "title": "Mugunghwa Silver Medal", "context": "Awarded the Korea Scout Association Mugunghwa Silver Medal (무궁화 은장).", "track": "Leader", "accent": "green"}, {"year": "2026", "title": "15th Korea Jamboree — Public Relations Director", "context": "Director of the Public Relations Department (홍보부 부장), Planning & Coordination HQ.", "track": "Leader", "accent": "green"}, {"year": "2026–", "title": "BP Media", "context": "I run BP Media, a Scouting-specialized media platform.", "track": "Leader", "accent": "green"}]};
function migrateTo31(doc) {
  const sc = doc.pages && doc.pages.scouting && doc.pages.scouting.sections;
  if (sc) sc.timeline = JSON.parse(JSON.stringify(V31_SCOUTING_TIMELINE));
  doc.version = 31;
  return doc;
}
// v32: Taiwan Rover host; 2016 Arab observers + national photography.
const V32_SCOUTING_TIMELINE = {"title": "A life in Scouting. A practice in communication.", "note": "From joining in 2003 through jamboree media, international contingents, and Asia-Pacific leadership. Expand a year to see the full list.", "items": [{"year": "2003", "title": "Joined Scouting as a Scout", "context": "I started Scouting as a Scout, experiencing people and activities first-hand in the field.", "track": "Scout", "accent": "neutral", "href": ""}, {"year": "2012", "title": "13th Korea Jamboree — Scout journalist", "context": "Participated as a Scout journalist (대원기자) at the 13th Korea Jamboree.", "track": "Scout", "accent": "neutral", "href": ""}, {"year": "2012.01", "title": "Bear Scout advancement No. 1420", "context": "Authorized as Bear Scout (범스카우트) No. 1420 on 20 January 2012 — Korea’s top Scout rank.", "track": "Scout", "accent": "neutral", "href": ""}, {"year": "2014", "title": "1st CJK-B — Korean Contingent journalist", "context": "Attended the 1st China–Japan–Korea Scouting Friendship (CJK-B) as a journalist with the Korean Contingent.", "track": "Leader", "accent": "neutral", "href": ""}, {"year": "2014", "title": "4th International Patrol Jamboree — newspaper design lead", "context": "Planning & Coordination HQ Media Center: lead for newspaper design.", "track": "Leader", "accent": "green", "href": ""}, {"year": "2014", "title": "6th Scout Journalism School — instructor", "context": "Instructor for the “I Am Also a Journalist” (나도저널리스트) program at the 6th Scout Journalism School.", "track": "Leader", "accent": "green", "href": ""}, {"year": "2014", "title": "Became a Scout Leader", "context": "I became a Scout Leader, moving into a role that guides and supports youth activities — built on my years as a Scout.", "track": "Leader", "accent": "green", "href": ""}, {"year": "2014", "title": "Intermediate Scout training completed", "context": "Completed Korea Scout Association intermediate training (중급훈련).", "track": "Leader", "accent": "neutral", "href": ""}, {"year": "2015", "title": "25th Asia-Pacific Scout Conference — PRESS video lead", "context": "Joined the PRESS media team and led the video unit.", "track": "Leader", "accent": "green", "href": ""}, {"year": "2015", "title": "ATAS membership No. 3226", "context": "Joined the Association of Top Achiever Scouts (ATAS) in 2015 (membership No. 3226).", "track": "Leader", "accent": "neutral", "href": ""}, {"year": "2015", "title": "Advanced Scout course completed", "context": "Completed Korea Scout Association advanced course (상급과정).", "track": "Leader", "accent": "neutral", "href": ""}, {"year": "2016", "title": "14th Korea Jamboree — video team leader", "context": "Planning & Coordination HQ Media Center: video team leader.", "track": "Leader", "accent": "green", "href": ""}, {"year": "2016", "title": "20th National Orienteering Competition — photography lead", "context": "Lead photographer for the 20th National Orienteering Competition (전국오리엔티어링대회).", "track": "Leader", "accent": "neutral", "href": ""}, {"year": "2016–2017", "title": "25th World Scout Jamboree bid — Brush Team deputy leader", "context": "Deputy team leader of the Brush Team during the bid campaign.", "track": "Leader", "accent": "neutral", "href": ""}, {"year": "2016–2017", "title": "25th World Scout Jamboree bid — supporters team leader", "context": "Team leader of the Jamboree bid supporters group.", "track": "Leader", "accent": "green", "href": ""}, {"year": "2016–2017", "title": "25th World Scout Jamboree bid — working committee", "context": "Practical promotion committee member for the bid; youth lead covering the Arab region.", "track": "Leader", "accent": "neutral", "href": ""}, {"year": "2016", "title": "3rd Arab Scout Youth Forum & 28th Arab Regional Conference — observer", "context": "Joined the Korean observer delegation to the 3rd Arab Scout Youth Forum and the 28th Arab Scout Regional Conference to promote Korea’s bid for the World Scout Jamboree.", "track": "Leader", "accent": "green", "href": ""}, {"year": "2016", "title": "3rd CJK-B — Head of Korean Contingent", "context": "Attended the 3rd China–Japan–Korea Scouting Friendship (CJK-B) as Head of the Korean Contingent.", "track": "Leader", "accent": "green", "href": ""}, {"year": "2016", "title": "6th WSPU youth exchange — photography", "context": "Photography for the youth exchange and the National Assembly invitation roundtable.", "track": "Leader", "accent": "neutral", "href": ""}, {"year": "2016", "title": "Daejeon Federation Cub Scout joint investiture — photography lead", "context": "Lead photographer for the Korea Scout Association Daejeon Federation Cub Scout joint investiture ceremony (컵스카우트 연합선서식).", "track": "Leader", "accent": "neutral", "href": ""}, {"year": "2016", "title": "Jeonnam Federation 25th Bear Scout advancement camp — photography lead", "context": "Lead photographer for the 25th Bear Scout (범스카우트) advancement camp of the Jeonnam Federation.", "track": "Leader", "accent": "neutral", "href": ""}, {"year": "2016", "title": "National-level event photography for Korea Scout Association", "context": "Regularly covered photography for various national-level Korea Scout Association events beyond the named assignments listed here.", "track": "Leader", "accent": "neutral", "href": ""}, {"year": "2016.08", "title": "8th Scout Journalism School — instructor", "context": "Instructor at the 8th Scout Journalism School (August 2016).", "track": "Leader", "accent": "green", "href": ""}, {"year": "2017", "title": "Asia-Pacific Scout Foundation — Associate Member", "context": "Joined the Asia-Pacific Region Scout Support Foundation as an Associate Member.", "track": "Leader", "accent": "green", "href": ""}, {"year": "2017", "title": "International Service Award", "context": "Received the Korea Scout Association International Service Award.", "track": "Leader", "accent": "green", "href": ""}, {"year": "2017", "title": "Korea Scout Association Citation Badge", "context": "Received the Korea Scout Association commendation badge (표창 기장).", "track": "Leader", "accent": "neutral", "href": ""}, {"year": "2017", "title": "National Rover Scout Conference — Korean observer", "context": "Joined the Korean observer delegation to the National Rover Scout Conference hosted by The General Association of the Scouts of China (Taiwan).", "track": "Leader", "accent": "neutral", "href": "https://en.scout.org.tw/"}, {"year": "2017.03", "title": "1st Scout Youth Mock National Assembly — mentor", "context": "Mentored at the 1st Scout Youth Mock National Assembly (스카우트 청소년모의국회).", "track": "Leader", "accent": "neutral", "href": ""}, {"year": "2017.08–2019.01", "title": "Uniform & Equipment Committee member", "context": "Member of the Korea Scout Association Uniform and Equipment Committee (제복장구위원회).", "track": "Leader", "accent": "neutral", "href": ""}, {"year": "2018", "title": "5th International Patrol Jamboree — design & archive lead", "context": "Planning & Coordination HQ Media Center: newspaper design and media archive lead.", "track": "Leader", "accent": "green", "href": ""}, {"year": "2018", "title": "President’s Citation, Korea Scout Association", "context": "Received the Korea Scout Association President’s Citation (총재 표창).", "track": "Leader", "accent": "green", "href": ""}, {"year": "2018.03", "title": "2nd Scout Youth Mock National Assembly — mentor", "context": "Mentored at the 2nd Scout Youth Mock National Assembly.", "track": "Leader", "accent": "neutral", "href": ""}, {"year": "2019.08", "title": "12th Scout Journalism School — photography instructor", "context": "Photography practical instructor at the 12th Scout Journalism School.", "track": "Leader", "accent": "green", "href": ""}, {"year": "2020", "title": "Mugunghwa Bronze Medal", "context": "Awarded the Korea Scout Association Mugunghwa Bronze Medal (무궁화 동장).", "track": "Leader", "accent": "green", "href": ""}, {"year": "2022", "title": "2nd World Digital Camporee — Marketing Director", "context": "Served as Marketing Headquarters Director for the 2nd World Digital Camporee (세계디지털야영대회).", "track": "Leader", "accent": "green", "href": ""}, {"year": "2022", "title": "Commissioner Course completed", "context": "Completed the Korea Scout Association Commissioner Course (커미셔너과정).", "track": "Leader", "accent": "neutral", "href": ""}, {"year": "2022–2024", "title": "National Commissioner, Korea Scout Association", "context": "Served as National Commissioner on PR II, working on domestic Scouting activity and communication.", "track": "Leader", "accent": "green", "href": ""}, {"year": "2022", "title": "Wood Badge completed", "context": "Completed Wood Badge qualification.", "track": "Leader", "accent": "green", "href": ""}, {"year": "2023", "title": "25th World Scout Jamboree — Korea Contingent media", "context": "Deputy Head of Media for the Korean Contingent at the 25th World Scout Jamboree.", "track": "Leader", "accent": "green", "href": ""}, {"year": "2024–2025", "title": "Future Value Committee — subcommittee chair", "context": "Served as a subcommittee chair of the Korea Scout Association Future Value Committee (미래가치위원회) and helped shape Vision 2032.", "track": "Leader", "accent": "green", "href": ""}, {"year": "2024", "title": "WE@FUTURE Jamboree — Head of Contingent", "context": "Head of Contingent at WE@FUTURE Jamboree, hosted by the Scout Association of Hong Kong.", "track": "Leader", "accent": "green", "href": ""}, {"year": "2024.01–", "title": "Unit Leader, Baengnyong Dongwoo Unit", "context": "Unit Leader (단대장) of Baengnyong Dongwoo Unit, Gyeonggi Southern Federation, Korea Scout Association — ongoing since January 2024.", "track": "Leader", "accent": "green", "href": ""}, {"year": "2025", "title": "28th Asia-Pacific Scout Conference — voting delegate", "context": "Full (voting) delegate of the Korean Contingent to the 28th Asia-Pacific Scout Conference.", "track": "Leader", "accent": "green", "href": ""}, {"year": "2025–2028", "title": "APR C&P Sub-Committee, 2nd Vice Chair", "context": "2nd Vice Chair of the Asia-Pacific Region Communications & Partnerships Sub-Committee.", "track": "Leader", "accent": "green", "href": ""}, {"year": "2025", "title": "Mugunghwa Silver Medal", "context": "Awarded the Korea Scout Association Mugunghwa Silver Medal (무궁화 은장).", "track": "Leader", "accent": "green", "href": ""}, {"year": "2026", "title": "15th Korea Jamboree — Public Relations Director", "context": "Director of the Public Relations Department (홍보부 부장), Planning & Coordination HQ.", "track": "Leader", "accent": "green", "href": ""}, {"year": "2026–", "title": "BP Media", "context": "I run BP Media, a Scouting-specialized media platform.", "track": "Leader", "accent": "green", "href": ""}]};
function migrateTo32(doc) {
  const sc = doc.pages && doc.pages.scouting && doc.pages.scouting.sections;
  if (sc) sc.timeline = JSON.parse(JSON.stringify(V32_SCOUTING_TIMELINE));
  doc.version = 32;
  return doc;
}
...
// v34: Head of PR; Baek-ryong; kind chips; Mugunghwa awards not roles.
const V34_SCOUTING = {"timeline": {"title": "A life in Scouting. A practice in communication.", "note": "From joining in 2003 through jamboree media, international contingents, and Asia-Pacific leadership. Expand a year to see the full list.", "items": [{"year": "2003", "title": "Joined Scouting as a Scout", "context": "I started Scouting as a Scout, experiencing people and activities first-hand in the field.", "track": "Scout", "accent": "neutral", "href": "", "kind": "participation"}, {"year": "2012", "title": "13th Korea Jamboree — Scout journalist", "context": "Participated as a Scout journalist (대원기자) at the 13th Korea Jamboree.", "track": "Scout", "accent": "neutral", "href": "", "kind": "participation"}, {"year": "2012.01", "title": "Bear Scout advancement No. 1420", "context": "Authorized as Bear Scout (범스카우트) No. 1420 on 20 January 2012 — Korea’s top Scout rank.", "track": "Scout", "accent": "neutral", "href": "", "kind": "participation"}, {"year": "2014", "title": "1st CJK-B — Korean Contingent journalist", "context": "Attended the 1st China–Japan–Korea Scouting Friendship (CJK-B) as a journalist with the Korean Contingent.", "track": "Leader", "accent": "neutral", "href": "", "kind": "participation"}, {"year": "2014", "title": "4th International Patrol Jamboree — newspaper design lead", "context": "Planning & Coordination HQ Media Center: lead for newspaper design.", "track": "Leader", "accent": "green", "href": "", "kind": "media"}, {"year": "2014", "title": "6th Scout Journalism School — instructor", "context": "Instructor for the “I Am Also a Journalist” (나도저널리스트) program at the 6th Scout Journalism School.", "track": "Leader", "accent": "green", "href": "", "kind": "instructor"}, {"year": "2014", "title": "Became a Scout Leader", "context": "I became a Scout Leader, moving into a role that guides and supports youth activities — built on my years as a Scout.", "track": "Leader", "accent": "green", "href": "", "kind": "leadership"}, {"year": "2014", "title": "Intermediate Scout training completed", "context": "Completed Korea Scout Association intermediate training (중급훈련).", "track": "Leader", "accent": "neutral", "href": "", "kind": "training"}, {"year": "2014–", "title": "National-level event photography for Korea Scout Association", "context": "From 2014 to the present, a core ongoing role: lead and dedicated photography for many national-level Korea Scout Association events.", "track": "Leader", "accent": "green", "href": "", "kind": "photography"}, {"year": "2015", "title": "25th Asia-Pacific Scout Conference — PRESS video lead", "context": "Joined the PRESS media team and led the video unit.", "track": "Leader", "accent": "green", "href": "", "kind": "media"}, {"year": "2015", "title": "ATAS membership No. 3226", "context": "Joined the Association of Top Achiever Scouts (ATAS) in 2015 (membership No. 3226).", "track": "Leader", "accent": "neutral", "href": "", "kind": "participation"}, {"year": "2015", "title": "Advanced Scout course completed", "context": "Completed Korea Scout Association advanced course (상급과정).", "track": "Leader", "accent": "neutral", "href": "", "kind": "training"}, {"year": "2016", "title": "14th Korea Jamboree — video team leader", "context": "Planning & Coordination HQ Media Center: video team leader.", "track": "Leader", "accent": "green", "href": "", "kind": "media"}, {"year": "2016", "title": "20th National Orienteering Competition — photography lead", "context": "Lead photographer for the 20th National Orienteering Competition (전국오리엔티어링대회).", "track": "Leader", "accent": "neutral", "href": "", "kind": "photography"}, {"year": "2016–2017", "title": "25th World Scout Jamboree bid — Brush Team deputy leader", "context": "Deputy team leader of the Brush Team during the bid campaign.", "track": "Leader", "accent": "neutral", "href": "", "kind": "bid"}, {"year": "2016–2017", "title": "25th World Scout Jamboree bid — supporters team leader", "context": "Team leader of the Jamboree bid supporters group.", "track": "Leader", "accent": "green", "href": "", "kind": "bid"}, {"year": "2016–2017", "title": "25th World Scout Jamboree bid — working committee", "context": "Practical promotion committee member for the bid; youth lead covering the Arab region.", "track": "Leader", "accent": "neutral", "href": "", "kind": "bid"}, {"year": "2016", "title": "3rd Arab Scout Youth Forum & 28th Arab Regional Conference — observer", "context": "Joined the Korean observer delegation to the 3rd Arab Scout Youth Forum and the 28th Arab Scout Regional Conference to promote Korea’s bid for the World Scout Jamboree.", "track": "Leader", "accent": "green", "href": "", "kind": "bid"}, {"year": "2016", "title": "3rd CJK-B — Head of Korean Contingent", "context": "Attended the 3rd China–Japan–Korea Scouting Friendship (CJK-B) as Head of the Korean Contingent.", "track": "Leader", "accent": "green", "href": "", "kind": "participation"}, {"year": "2016", "title": "6th WSPU youth exchange — photography", "context": "Photography for the youth exchange and the National Assembly invitation roundtable.", "track": "Leader", "accent": "neutral", "href": "", "kind": "photography"}, {"year": "2016", "title": "Daejeon Federation Cub Scout joint investiture — photography lead", "context": "Lead photographer for the Korea Scout Association Daejeon Federation Cub Scout joint investiture ceremony (컵스카우트 연합선서식).", "track": "Leader", "accent": "neutral", "href": "", "kind": "photography"}, {"year": "2016", "title": "Jeonnam Federation 25th Bear Scout advancement camp — photography lead", "context": "Lead photographer for the 25th Bear Scout (범스카우트) advancement camp of the Jeonnam Federation.", "track": "Leader", "accent": "neutral", "href": "", "kind": "photography"}, {"year": "2016.08", "title": "8th Scout Journalism School — instructor", "context": "Instructor at the 8th Scout Journalism School (August 2016).", "track": "Leader", "accent": "green", "href": "", "kind": "instructor"}, {"year": "2017", "title": "Asia-Pacific Scout Foundation — Associate Member", "context": "Joined the Asia-Pacific Region Scout Support Foundation as an Associate Member.", "track": "Leader", "accent": "green", "href": "", "kind": "leadership"}, {"year": "2017", "title": "International Service Award", "context": "Received the Korea Scout Association International Service Award.", "track": "Leader", "accent": "green", "href": "", "kind": "award"}, {"year": "2017", "title": "Korea Scout Association Citation Badge", "context": "Received the Korea Scout Association commendation badge (표창 기장).", "track": "Leader", "accent": "neutral", "href": "", "kind": "award"}, {"year": "2017", "title": "National Rover Scout Conference — Korean observer", "context": "Joined the Korean observer delegation to the National Rover Scout Conference hosted by The General Association of the Scouts of China (Taiwan).", "track": "Leader", "accent": "neutral", "href": "https://en.scout.org.tw/", "kind": "participation"}, {"year": "2017.03", "title": "1st Scout Youth Mock National Assembly — mentor", "context": "Mentored at the 1st Scout Youth Mock National Assembly (스카우트 청소년모의국회).", "track": "Leader", "accent": "neutral", "href": "", "kind": "mentoring"}, {"year": "2017.08–2019.01", "title": "Uniform & Equipment Committee member", "context": "Member of the Korea Scout Association Uniform and Equipment Committee (제복장구위원회).", "track": "Leader", "accent": "neutral", "href": "", "kind": "leadership"}, {"year": "2018", "title": "5th International Patrol Jamboree — design & archive lead", "context": "Planning & Coordination HQ Media Center: newspaper design and media archive lead.", "track": "Leader", "accent": "green", "href": "", "kind": "media"}, {"year": "2018", "title": "President’s Citation, Korea Scout Association", "context": "Received the Korea Scout Association President’s Citation (총재 표창).", "track": "Leader", "accent": "green", "href": "", "kind": "award"}, {"year": "2018.03", "title": "2nd Scout Youth Mock National Assembly — mentor", "context": "Mentored at the 2nd Scout Youth Mock National Assembly.", "track": "Leader", "accent": "neutral", "href": "", "kind": "mentoring"}, {"year": "2019.08", "title": "12th Scout Journalism School — photography instructor", "context": "Photography practical instructor at the 12th Scout Journalism School.", "track": "Leader", "accent": "green", "href": "", "kind": "photography"}, {"year": "2020", "title": "Mugunghwa Bronze Medal", "context": "Awarded the Korea Scout Association Mugunghwa Bronze Medal (무궁화 동장).", "track": "Leader", "accent": "green", "href": "", "kind": "award"}, {"year": "2022", "title": "2nd World Digital Camporee — Marketing Director", "context": "Served as Marketing Headquarters Director for the 2nd World Digital Camporee (세계디지털야영대회).", "track": "Leader", "accent": "green", "href": "", "kind": "leadership"}, {"year": "2022", "title": "Commissioner Course completed", "context": "Completed the Korea Scout Association Commissioner Course (커미셔너과정).", "track": "Leader", "accent": "neutral", "href": "", "kind": "training"}, {"year": "2022–2024", "title": "National Commissioner, Korea Scout Association", "context": "Served as National Commissioner on PR II, working on domestic Scouting activity and communication.", "track": "Leader", "accent": "green", "href": "", "kind": "leadership"}, {"year": "2022", "title": "Wood Badge completed", "context": "Completed Wood Badge qualification.", "track": "Leader", "accent": "green", "href": "", "kind": "training"}, {"year": "2023", "title": "25th World Scout Jamboree — Korea Contingent media", "context": "Deputy Head of Media for the Korean Contingent at the 25th World Scout Jamboree.", "track": "Leader", "accent": "green", "href": "", "kind": "media"}, {"year": "2024–2025", "title": "Future Value Committee — subcommittee chair", "context": "Served as a subcommittee chair of the Korea Scout Association Future Value Committee (미래가치위원회) and helped shape Vision 2032.", "track": "Leader", "accent": "green", "href": "", "kind": "leadership"}, {"year": "2024", "title": "WE@FUTURE Jamboree — Head of Contingent", "context": "Head of Contingent at WE@FUTURE Jamboree, hosted by the Scout Association of Hong Kong.", "track": "Leader", "accent": "green", "href": "", "kind": "leadership"}, {"year": "2024.01–", "title": "Unit Leader, Baek-ryong Unit", "context": "Unit Leader (단대장) of Baek-ryong Unit, Gyeonggi Southern Federation, Korea Scout Association — ongoing since January 2024.", "track": "Leader", "accent": "green", "href": "", "kind": "leadership"}, {"year": "2025", "title": "28th Asia-Pacific Scout Conference — voting delegate", "context": "Full (voting) delegate of the Korean Contingent to the 28th Asia-Pacific Scout Conference.", "track": "Leader", "accent": "green", "href": "", "kind": "participation"}, {"year": "2025–2028", "title": "APR C&P Sub-Committee, 2nd Vice Chair", "context": "2nd Vice Chair of the Asia-Pacific Region Communications & Partnerships Sub-Committee.", "track": "Leader", "accent": "green", "href": "", "kind": "leadership"}, {"year": "2025", "title": "Mugunghwa Silver Medal", "context": "Awarded the Korea Scout Association Mugunghwa Silver Medal (무궁화 은장).", "track": "Leader", "accent": "green", "href": "", "kind": "award"}, {"year": "2026", "title": "15th Korea Jamboree — Head of PR Department", "context": "Head of PR Department (홍보부 부장), Planning & Coordination HQ.", "track": "Leader", "accent": "green", "href": "", "kind": "leadership"}, {"year": "2026–", "title": "BP Media", "context": "I run BP Media, a Scouting-specialized media platform.", "track": "Leader", "accent": "green", "href": "", "kind": "media"}]}, "roles": {"title": "Roles behind the relationships", "items": [{"title": "Unit Leader · Baek-ryong Unit", "org": "Gyeonggi Southern Federation, KSA", "period": "2024.01–", "accent": "green"}, {"title": "APR Communication & Partnerships", "org": "2nd Vice Chair", "period": "2025–2028", "accent": "neutral"}, {"title": "National Commissioner on PR II", "org": "Korea Scout Association", "period": "2022–2024", "accent": "neutral"}, {"title": "Future Value Committee — subcommittee chair", "org": "Korea Scout Association · Vision 2032", "period": "2024–2025", "accent": "neutral"}, {"title": "Head of Contingent", "org": "WE@FUTURE Jamboree (Hong Kong)", "period": "2024", "accent": "neutral"}, {"title": "Deputy Head of Media · Korean Contingent", "org": "25th World Scout Jamboree", "period": "2023", "accent": "neutral"}, {"title": "Head of PR Department", "org": "15th Korea Jamboree · Planning & Coordination HQ", "period": "2026", "accent": "neutral"}, {"title": "BP Media", "org": "Founder", "period": "2026–", "accent": "green"}]}};
function migrateTo34(doc) {
  const sc = doc.pages && doc.pages.scouting && doc.pages.scouting.sections;
  if (sc) {
    sc.timeline = JSON.parse(JSON.stringify(V34_SCOUTING.timeline));
    sc.roles = JSON.parse(JSON.stringify(V34_SCOUTING.roles));
  }
  doc.version = 34;
  return doc;
}
...
// v39: make the hero begin with reassurance and a concrete, useful outcome.
// Only the exact v38 hero copy changes; owner-written alternatives remain intact.
function migrateTo39(doc) {
  const hero = doc.pages && doc.pages.home && doc.pages.home.sections && doc.pages.home.sections.hero;
  if (hero && hero.title === "I choose the right medium—\nand carry the work through.") {
    hero.title = DEFAULT.pages.home.sections.hero.title;
  }
  if (hero && hero.lead === "I’m Jimmy Park, a Korea-based producer and builder. I begin with the people and purpose, then take the work from first brief to finished film, working platform, or practical AI workflow. The value I bring is not one tool; it is the judgment to connect the right ones.") {
    hero.lead = DEFAULT.pages.home.sections.hero.lead;
  }
  doc.version = 39;
  return doc;
}
...
export async function onRequestGet({ env }) {
  ...
  if ((doc.version || 0) < 27) doc = migrateTo27(doc);
  if ((doc.version || 0) < 28) doc = migrateTo28(doc);
  if ((doc.version || 0) < 29) doc = migrateTo29(doc);
...
export async function onRequestPut({ request, env }) {
  ...
  if (incoming.version < 27) migrateTo27(incoming);
  if (incoming.version < 28) migrateTo28(incoming);
  if (incoming.version < 29) migrateTo29(incoming);
