...
(function () {
  ...
  var CHARACTERS = [
    {
      id: 'wood_mori', el: 0, name: '모리', type: '숲의 정령', emoji: '🌱',
      img: '/assets/img/saju-ch-wood.png',
      short: '작은 시작과 성장을 도와주는 숲의 정령',
      long: '나뭇가지 지팡이를 든 초록 숲의 정령. 새로운 시작 앞에서 망설일 때, 아주 작은 첫걸음을 조용히 밀어줍니다.',
      quote: '모리는 거창한 변화를 말하지 않습니다.\n대신 오늘 할 수 있는 작은 시작을 조용히 밀어줍니다.',
      lackMsg: '목(木)은 "일단 해보자!" 하고 폴짝 일어나는 새싹 같은 기운이에요. 당신 사주엔 이 목 기운이 살짝 옅게 나왔어요 — 하고 싶은 리스트는 가득한데 첫 발이 유난히 무겁죠. 하지만 부족한 건 능력이 아니라 "작은 시작 스위치" 하나예요. 목의 기운은 하루 5분짜리 작은 행동에서 자라나거든요. 그래서 데려온 친구가 숲의 정령 모리 — 오늘 할 수 있는 가장 작은 시작을 조용히 함께 떼어줄 거예요!',
    ...
    },
    {
      ...
      img: '/assets/img/saju-ch-fire.png',
    ...
    {
      id: 'earth_duri', el: 2, name: '두리', type: '포근한 감자', emoji: '🥔',
      img: '/assets/img/saju-ch-earth.png',
      short: '흩어진 마음의 중심을 잡아주는 포근한 감자',
      long: '느긋하고 단단한 흙빛 감자. 생각이 많아지거나 생활이 흐트러질 때, 흩어진 것들을 모아 다시 중심을 잡아줍니다.',
      quote: '두리는 빠른 답을 주지 않습니다.\n대신 무너지지 않도록 옆에서 묵직하게 버텨줍니다.',
      lackMsg: '토(土)는 흩어진 걸 모아 중심을 잡아주는 든든한 땅 같은 기운이에요. 당신 사주엔 이 토 기운이 살짝 옅게 나왔어요 — 마음도 일정도 관심사도 쉽게 우르르 흩어지는 편이죠. 하지만 게을러서가 아니라 세상 모든 게 재미있어 보이는 호기심 넘치는 사람이라는 증거예요. 지금 필요한 건 흩어진 걸 묶어줄 "무게중심" 하나뿐이죠. 그래서 데려온 친구가 포근한 감자 두리 — 무너지지 않게 옆에서 묵직하게 버텨줄 거예요!',
      ...
      products: ['감자 인형', '안정 루틴 플래너', '"오늘의 중심" 카드', '베이지톤 힐링 스티커'],
      cta: '두리와 함께 오늘의 중심을 잡아보세요.'
    },
    {
      id: 'metal_gadi', el: 3, name: '가디', type: '은빛 기사', emoji: '🛡️',
      img: '/assets/img/saju-ch-metal.png',
      short: '복잡한 생각을 정리해주는 은빛 기사',
      long: '검과 방패를 든 늠름한 은빛 기사. 선택이 복잡해졌을 때, 필요한 것과 아닌 것을 구분해 기준을 세우도록 돕습니다.',
      quote: '가디는 많은 말을 하지 않습니다.\n대신 무엇을 남기고 무엇을 덜어낼지 조용히 알려줍니다.',
      lackMsg: '금(金)은 엉킨 걸 "이건 남기고, 이건 안녕" 하고 정리해주는 서늘하고 예리한 기운이에요. 당신 사주엔 이 금 기운이 살짝 옅게 나왔어요 — 생각도 물건도 감정도 자꾸 쌓아두는 편이죠. 하지만 우유부단해서가 아니라 모든 가능성을 소중히 여기는 다정한 사람이라는 뜻이에요. 지금 필요한 건 "나만의 기준" 하나뿐이죠. 그래서 데려온 친구가 은빛 기사 가디 — 무엇을 남기고 덜어낼지 조용히 알려줄 거예요!',
      whenLow: ['#다좋아보여서고민', '#장바구니는나의로망', '#고민많은다정한사람', '#뭐든소중히여겨', '#천천히골라도돼', '#내기준찾는중', '#선택도연습이야', '#마음이넓어서그래', '#조금씩덜어가는중', '#신중한선택파', '#또렷해지는중', '#가디와함께'],
      roleShort: '정리와 결단을 도와주는',
      products: ['은빛 기사 키링', '할 일 정리 메모패드', '미니멀 스티커팩', '"오늘의 기준" 체크리스트'],
      cta: '가디와 함께 복잡한 생각을 정리해보세요.'
    },
    {
      id: 'water_noa', el: 4, name: '노아', type: '물방울 정령', emoji: '💧',
      img: '/assets/img/saju-ch-water.png',
      short: '멈춤과 회복을 도와주는 물방울 정령',
      long: '방울방울 가볍게 흐르는 물방울 정령. 너무 오래 긴장했을 때, 지친 에너지를 회복시켜 다시 천천히 흐르도록 돕습니다.',
      quote: '노아는 재촉하지 않습니다.\n잠시 멈추고, 숨을 고르고, 다시 흐르게 합니다.',
      lackMsg: '수(水)는 잠깐 멈춰 숨을 고르며 흐름을 읽는 잔잔한 물 같은 기운이에요. 당신 사주엔 이 수 기운이 살짝 옅게 나왔어요 — 쉬는 법을 자꾸 잊고 몸도 마음도 바짝 마른 느낌이 들 때가 있죠. 하지만 유난스러워서가 아니라 그만큼 성실한 사람이라는 증거예요. 지금 필요한 건 "잠깐의 쉼표" 하나죠. 그래서 데려온 친구가 물방울 정령 노아 — 잠시 멈추고 다시 천천히 흐르게 도와줄 거예요!',
      ...
      products: ['물방울 인형', '회복 다이어리', '감정 기록 스티커', '"오늘의 흐름" 명상 카드'],
  ...
  var STEM_DEEP = [
    { kw: ['개척', '직진', '리더십', '자존심'],
      who: '숲에서 가장 먼저 하늘로 뻗는 거목이에요. 목표가 생기면 곧게 직진하고, 무언가를 시작하는 자리에서 힘이 나는 개척자 타입이죠.',
      people: '관계에서도 먼저 나서서 이끄는 편이에요. 뒤에서 재기보다 앞에서 부딪히는 게 편하고, 그 솔직한 에너지에 주변이 자연스럽게 따라와요.',
      work: '새 프로젝트의 첫 삽, 0을 1로 만드는 일과 잘 맞아요. 반대로 촘촘한 반복 관리 업무는 답답해하는 편이죠.',
      tip: '곧은 나무는 가끔 꺾여요. 중요한 고비에서는 덩굴처럼 휘어 가는 유연함을 한 스푼 빌려오기 — 그럼 무적이에요.' },
    { kw: ['유연함', '생존력', '섬세함', '친화력'],
      who: '바위를 만나면 감아서 넘어가는 덩굴이에요. 환경이 어떻든 제 길을 찾아내는, 부드럽지만 끈질긴 생명력의 소유자죠.',
      people: '사람 사이의 온도를 잘 읽어요. 분위기를 부드럽게 만들고, 실속 있게 관계를 오래 가져가는 타입이에요.',
      work: '협상과 조율, 디테일을 다듬는 일에서 진가가 나와요. 정면 돌파보다 우회 전략이 특기죠.',
      tip: '휘어지는 게 특기지만, 정말 중요한 순간엔 한 번 곧게 서 보기 — 그때 판이 바뀌어요.' },
    { kw: ['존재감', '긍정', '공명정대', '확산'],
      who: '만물을 공평하게 비추는 태양이에요. 있는 것만으로 공간이 환해지는 존재감, 숨기는 게 없는 시원시원함이 매력이죠.',
      people: '차별 없이 두루 밝게 대해서 인기가 많아요. 대신 넓고 얕은 관계가 되기 쉬우니, 깊은 인연은 따로 챙겨두기.',
      work: '무대, 발표, 브랜딩, 리딩 — 드러나는 자리에서 힘이 나요. 뒤에서 묵묵히만 하는 일은 에너지가 새는 편이에요.',
      tip: '태양은 매일 뜨는 게 일이라 번아웃을 모른 채 달리기 쉬워요. 일몰 시간을 스케줄에 넣어두기.' },
    { kw: ['집중', '온기', '섬세함', '꾸준함'],
      who: '어둠 속에서 더 빛나는 등불이에요. 화려하게 타오르기보다 오래, 깊게, 필요한 곳을 정확히 비추는 불이죠.',
      people: '한 사람 한 사람에게 온기를 주는 타입이라 곁의 사람들이 오래 남아요. 넓은 인맥보다 깊은 신뢰가 자산이에요.',
      work: '전문성을 파고드는 일, 완성도가 중요한 일에서 빛나요. 한번 몰입하면 시간 가는 줄 모르죠.',
      tip: '심지가 닳는 줄 모르고 타기 쉬워요. 내 불씨를 지키는 최소한의 이기심은 필수예요.' },
    { kw: ['신뢰', '포용', '중심', '묵직함'],
      who: '흔들리지 않는 큰 산이에요. 말수가 많지 않아도 존재만으로 주변이 안정되는, 기대고 싶은 사람이죠.',
      people: '먼저 다가가진 않아도 한번 품은 사람은 끝까지 챙겨요. 위기의 순간에 진가가 드러나는 관계형이에요.',
      work: '조직의 중심을 잡는 일 — 운영, 총괄, 중재 — 와 잘 맞아요. 잦은 변화보다 긴 호흡의 일에서 강하죠.',
      tip: '산은 스스로 움직이지 않아요. 가끔은 먼저 연락하고 먼저 움직여 보기 — 그때 산이 더 커 보여요.' },
    { kw: ['실속', '성실', '돌봄', '현실감각'],
      who: '무엇이든 심으면 길러내는 기름진 밭이에요. 화려하진 않지만 결과로 증명하는 실속형 성실러죠.',
      people: '티 안 나게 챙겨주는 타입이라 곁에 있으면 편안해요. 그 진심을 아는 사람들이 곁에 차곡차곡 쌓여요.',
      work: '기르고 키우는 일 — 교육, 운영, 재정, 관리 — 에서 강해요. 꾸준함이 복리로 쌓이는 타입이에요.',
      tip: '남의 농사를 지어주다 내 밭을 잊기 쉬워요. 내 몫을 챙기는 것도 성실의 일부예요.' },
    { kw: ['결단력', '의리', '추진력', '원칙'],
      who: '두드릴수록 단단해지는 무쇠예요. 망설임 없이 끊고 맺는 결단력, 한번 뱉은 말은 지키는 의리가 시그니처죠.',
      people: '돌려 말하지 않아서 시원하다는 소리를 들어요. 신뢰가 쌓이면 누구보다 든든한 내 편이 되는 타입이에요.',
      work: '결정하고 실행하고 책임지는 일과 잘 맞아요. 구조를 세우고 기준을 만드는 데 재능이 있죠.',
      tip: '무쇠도 담금질이 필요해요. 직설이 상처가 되지 않게, 말의 온도만 한 스푼 올려보기.' },
    { kw: ['예리함', '완성도', '자존감', '심미안'],
      who: '세공을 마친 보석이에요. 디테일을 놓치지 않는 예리함, 스스로에 대한 기준이 높은 정제된 사람이죠.',
      people: '아무나와 어울리기보다 결이 맞는 소수와 깊게 가요. 그 안에서는 누구보다 세심하고 의리가 깊죠.',
      work: '완성도가 생명인 일 — 기획, 디자인, 품질, 전문 영역 — 에서 빛나요. 대충은 못 하는 타입이에요.',
      tip: '기준이 높은 만큼 자신에게 제일 엄격해요. 80점의 나도 충분히 보석이라는 걸 잊지 말기.' },
    { kw: ['스케일', '포용', '지략', '자유'],
      who: '넓고 깊은 바다예요. 웬만한 일은 다 품어버리는 스케일, 멀리 내다보는 지략이 강점인 큰물이죠.',
      people: '다양한 사람을 편견 없이 품어요. 다만 속이 깊어서 진짜 마음은 잘 안 보여주는 편이에요.',
      work: '판을 크게 보는 일 — 전략, 기획, 글로벌, 흐름을 읽는 일 — 과 잘 맞아요. 좁은 틀에 가두면 답답해하죠.',
      tip: '바다는 방향이 없으면 그냥 넓기만 해요. 큰 그릇 위에 구체적인 목표 하나를 띄워두기.' },
    { kw: ['통찰', '공감', '스며듦', '지혜'],
      who: '소리 없이 만물을 적시는 단비예요. 눈에 띄지 않게 스며들어 어느새 판을 바꿔놓는, 조용한 지혜의 소유자죠.',
      people: '사람 마음의 온도 변화를 가장 먼저 알아채요. 위로가 필요한 순간 조용히 곁에 있어주는 타입이에요.',
      work: '관찰과 통찰이 무기인 일 — 분석, 상담, 글, 연구 — 에서 강해요. 소리 없이 스며드는 영향력이죠.',
      tip: '다 읽어내는 만큼 혼자 삭이기 쉬워요. 내 마음의 우산도 가끔은 남에게 맡겨보기.' }
  ];
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    function charCard(ch, isMain, whyHtml) {
      ...
      return '<div class="sj-char" style="background:' + el.light + '; border-color:' + el.text + '33;">' +
        '<div class="sj-char-head">' +
          '<img class="sj-char-img" src="' + ch.img + '" alt="' + ch.type + ' ' + ch.name + '" width="88" height="88" loading="lazy">' +
    ...
    function render(r) {
      ...
      // 나의 중심 — 일간 딥다이브 (풍성한 기운과 부족 캐릭터 사이, 사용자 지시 위치)
      var ilganBox = $('sj-ilgan');
      if (ilganBox) {
        var igStem = STEMS[pl.day.stem], igProf = STEM_PROFILE[pl.day.stem], igDeep = STEM_DEEP[pl.day.stem];
        var igEl = ELEMENTS[igStem.el];
        ilganBox.innerHTML =
          ...
          '<p class="sjd-el-msg"><b>일에서는</b> — ' + igDeep.work + '</p>' +
          '<p class="sjd-el-msg sjd-ig-tip"><b>한 끗 팁</b> — ' + igDeep.tip + '</p>' +
          '<p class="sj-ey-note">일간(일주의 하늘 기운)은 사주 여덟 글자의 기준점 — 위 캐릭터와 배경, 그리고 아래 추천까지 모두 이 글자를 중심으로 읽어요.</p>';
      }
    ...
    function renderDetail(r) {
      ...
      $('sjd-summary').innerHTML =
        ...
        '%</b>는요? 모자란 게 아니라 아직 안 쓴 근육에 가까워요. 챙기는 순간 밸런스가 확 좋아지는 진짜 보완 포인트죠. 이제 네 기둥 → 합·충 케미 → 다섯 가지 힘 → 신살과 길성 → 올해의 흐름 순서로 하나씩 풀어볼게요. 마지막엔 나랑 잘 맞는 것들과 채우는 법까지.</p>';
