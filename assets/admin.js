...
(function () {
  ...
  var SCHEMA = {
    ...
    work: { title: "Work", kind: "page", page: "work", sections: [
      ...
      { id: "vibecoding", title: "AI in Practice", fields: [F("kicker", "Kicker"), F("title", "Title"), F("sub", "Sub-label"), F("desc", "Description", "textarea")], collections: [{ k: "items", label: "Projects", fields: [F("slug", "Slug (browser bar)"), F("title", "Title"), F("desc", "Description"), F("status", "Status", "select", STATUS), F("accent", "Accent", "select", ACCENT_NG)], images: [["image", "Image"]], tmpl: { slug: "", title: "", desc: "", status: "Prototype", accent: "neutral", image: "" } }] },
